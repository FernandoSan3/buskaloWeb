            ...
            $address = !empty($request->address) ? $request->address : '' ;
                ...
                if($validator->fails())
                {
                    ...
                    if(!empty($userEntity))
                    {
						...
						return redirect()->route('frontend.contractor.workers')->withFlashSuccess(__('Profile Created Successfully.!'));
                    }
                    else
                    {
                      return redirect()->route('frontend.contractor.workers')->withFlashDanger(__('Invalid user.'));
