                        ...
                        if(!empty($userid))
                            {
	                            ...
	                            if(!empty($servicesOffered))
	                            {
	                                    ...
	                                    return view('frontend.companay.company_profile.services')->withData($allData);
	                             }
	                             else
	                             {
	                                return redirect()->route('frontend.companay.company_profile')->withFlashDanger(__('alerts.frontend.company.services.services_not_found'));
	                             }
                            ...
                            else
                            {
                                ...
                                return redirect()->route('frontend.company.company_profile')->withFlashDanger(__('alerts.frontend.company.services.invalid_user'));
                            }
