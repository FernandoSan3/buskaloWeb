...
class ContractorMessagesController extends Controller
{
    ...
    { 
        ...
        foreach ($messages as $message) {
            ...
            $return[] = view('frontend.contractor.chat-line')->with('message', $message)->render();
...
/**
     ...
     * @param Request $request
     */
    public function postContSendMessage(Request $request)
    {
         //return response()->json(['data' => 'hello']); die;
