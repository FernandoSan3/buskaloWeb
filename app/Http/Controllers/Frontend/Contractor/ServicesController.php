    ...
    public function index()
    {
        ...
        if(!empty($userid)) 
        {
            ...
            if(!empty($servicesOffered))
            {
             ...
             {
                return redirect()->route('frontend.contractor.my-profile')->withFlashDanger(__('alerts.frontend.constractor.services.services_not_found')); 
             }
        ...
        else
        {
            ...
            return redirect()->route('frontend.contractor.my-profile')->withFlashDanger(__('alerts.frontend.constractor.services.invalid_user')); 
        }
    }                
        ///////////////////////services offered////////////////
