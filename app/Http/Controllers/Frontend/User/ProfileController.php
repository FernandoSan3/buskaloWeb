   ...
   public function updateBasicInfo(Request $request)
    {
        ...
        if(!empty($userEntity))
        {
            ...
            return redirect()->route('frontend.user.dashboard')->withFlashSuccess(__('alerts.frontend.users.profile.profile_updated_successfully')); 
        }
      else
        {
          return redirect()->route('frontend.user.dashboard')->withFlashDanger(__('alerts.frontend.users.invalid_user')); 
    ...
    public function updateUserProfilePicture(Request $request)
    {
        ...
        if(!empty($userEntity))
        {
           ...
           return redirect()->route('frontend.user.dashboard')->withFlashSuccess(__('alerts.frontend.users.profile_picture_updated_successfully')); 
        }
        else
        {
          return redirect()->route('frontend.user.dashboard')->withFlashDanger(__('alerts.frontend.users.invalid_user')); 
