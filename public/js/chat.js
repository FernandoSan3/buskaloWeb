    ...
    return `
        ...
        <div class="col-md-10 col-10">
            <div class="messages msg_sent text-right">
                ...
                <time datetime="${message.data.dateTimeStr}"> ${message.data.fromUserName} • ${message.data.dateHumanReadable} </time>
            </div>
        </div>
        <div class="col-md-2 col-2 avatar">
    <img src="${message.data.from_user_profile}" width="50" height="50" class="img-responsive">
    </div>
    `;
}
...
function getMessageReceiverHtml(message)
{
    return `
           ...
           <div class="col-md-2 col-2 avatar">
             <img src="${message.from_user_profile}" width="50" height="50" class="img-responsive">
           </div>
        <div class="col-md-10 col-10">
