function PaymentForm(elem) {
    (this.elem = jQuery(elem)),
        ...
        (this.captureEmail = !!this.elem.data("capture-email") && this.elem.data("capture-email")),
        (this.captureCellPhone = !!this.elem.data("capture-cellphone") && this.elem.data("capture-cellphone")),
        (this.captureName = !!this.elem.data("capture-name") && this.elem.data("capture-name")),
        (this.iconColour = !!this.elem.data("icon-colour") && this.elem.data("icon-colour")),
        (this.EXPIRY_USE_DROPDOWNS = !!this.elem.data("use-dropdowns") && this.elem.data("use-dropdowns")),
        (this.exclusiveTypes = !!this.elem.data("exclusive-types") && this.elem.data("exclusive-types").split(",")),
        (this.invalidCardTypeMessage = !!this.elem.data("invalid-card-type-message") && this.elem.data("invalid-card-type-message")),
        (this.cvcLenght = 3),
        (this.nipLenght = 4),
        ...
        this.captureCellPhone && (this.refreshCellPhoneFormat(), this.refreshCellphoneCountryCode());
}
(Payment.COUNTRIES = [
    { flag: "https://restcountries.eu/data/afg.svg", name: "Afghanistan", calling_code: "93" },
    { flag: "https://restcountries.eu/data/ala.svg", name: "Aland Islands", calling_code: "358" },
    { flag: "https://restcountries.eu/data/alb.svg", name: "Albania", calling_code: "355" },
    { flag: "https://restcountries.eu/data/dza.svg", name: "Algeria", calling_code: "213" },
    { flag: "https://restcountries.eu/data/and.svg", name: "Andorra", calling_code: "376" },
    { flag: "https://restcountries.eu/data/ago.svg", name: "Angola", calling_code: "244" },
    { flag: "https://restcountries.eu/data/ata.svg", name: "Antarctica", calling_code: "672" },
    { flag: "https://restcountries.eu/data/arg.svg", name: "Argentina", calling_code: "54" },
    { flag: "https://restcountries.eu/data/arm.svg", name: "Armenia", calling_code: "374" },
    { flag: "https://restcountries.eu/data/abw.svg", name: "Aruba", calling_code: "297" },
    { flag: "https://restcountries.eu/data/aus.svg", name: "Australia", calling_code: "61" },
    { flag: "https://restcountries.eu/data/aut.svg", name: "Austria", calling_code: "43" },
    { flag: "https://restcountries.eu/data/aze.svg", name: "Azerbaijan", calling_code: "994" },
    { flag: "https://restcountries.eu/data/bhr.svg", name: "Bahrain", calling_code: "973" },
    { flag: "https://restcountries.eu/data/bgd.svg", name: "Bangladesh", calling_code: "880" },
    { flag: "https://restcountries.eu/data/blr.svg", name: "Belarus", calling_code: "375" },
    { flag: "https://restcountries.eu/data/bel.svg", name: "Belgium", calling_code: "32" },
    { flag: "https://restcountries.eu/data/blz.svg", name: "Belize", calling_code: "501" },
    { flag: "https://restcountries.eu/data/ben.svg", name: "Benin", calling_code: "229" },
    { flag: "https://restcountries.eu/data/btn.svg", name: "Bhutan", calling_code: "975" },
    { flag: "https://restcountries.eu/data/bol.svg", name: "Bolivia (Plurinational State of)", calling_code: "591" },
    { flag: "https://restcountries.eu/data/bih.svg", name: "Bosnia and Herzegovina", calling_code: "387" },
    { flag: "https://restcountries.eu/data/bwa.svg", name: "Botswana", calling_code: "267" },
    { flag: "https://restcountries.eu/data/bra.svg", name: "Brazil", calling_code: "55" },
    { flag: "https://restcountries.eu/data/iot.svg", name: "British Indian Ocean Territory", calling_code: "246" },
    { flag: "https://restcountries.eu/data/brn.svg", name: "Brunei Darussalam", calling_code: "673" },
    { flag: "https://restcountries.eu/data/bgr.svg", name: "Bulgaria", calling_code: "359" },
    { flag: "https://restcountries.eu/data/bfa.svg", name: "Burkina Faso", calling_code: "226" },
    { flag: "https://restcountries.eu/data/bdi.svg", name: "Burundi", calling_code: "257" },
    { flag: "https://restcountries.eu/data/khm.svg", name: "Cambodia", calling_code: "855" },
    { flag: "https://restcountries.eu/data/cmr.svg", name: "Cameroon", calling_code: "237" },
    { flag: "https://restcountries.eu/data/can.svg", name: "Canada", calling_code: "1" },
    { flag: "https://restcountries.eu/data/cpv.svg", name: "Cabo Verde", calling_code: "238" },
    { flag: "https://restcountries.eu/data/caf.svg", name: "Central African Republic", calling_code: "236" },
    { flag: "https://restcountries.eu/data/tcd.svg", name: "Chad", calling_code: "235" },
    { flag: "https://restcountries.eu/data/chl.svg", name: "Chile", calling_code: "56" },
    { flag: "https://restcountries.eu/data/chn.svg", name: "China", calling_code: "86" },
    { flag: "https://restcountries.eu/data/cxr.svg", name: "Christmas Island", calling_code: "61" },
    { flag: "https://restcountries.eu/data/cck.svg", name: "Cocos (Keeling) Islands", calling_code: "61" },
    { flag: "https://restcountries.eu/data/col.svg", name: "Colombia", calling_code: "57" },
    { flag: "https://restcountries.eu/data/com.svg", name: "Comoros", calling_code: "269" },
    { flag: "https://restcountries.eu/data/cog.svg", name: "Congo", calling_code: "242" },
    { flag: "https://restcountries.eu/data/cod.svg", name: "Congo (Democratic Republic of the)", calling_code: "243" },
    { flag: "https://restcountries.eu/data/cok.svg", name: "Cook Islands", calling_code: "682" },
    { flag: "https://restcountries.eu/data/cri.svg", name: "Costa Rica", calling_code: "506" },
    { flag: "https://restcountries.eu/data/hrv.svg", name: "Croatia", calling_code: "385" },
    { flag: "https://restcountries.eu/data/cub.svg", name: "Cuba", calling_code: "53" },
    { flag: "https://restcountries.eu/data/cuw.svg", name: "Curacao", calling_code: "599" },
    { flag: "https://restcountries.eu/data/cyp.svg", name: "Cyprus", calling_code: "357" },
    { flag: "https://restcountries.eu/data/cze.svg", name: "Czech Republic", calling_code: "420" },
    { flag: "https://restcountries.eu/data/dnk.svg", name: "Denmark", calling_code: "45" },
    { flag: "https://restcountries.eu/data/dji.svg", name: "Djibouti", calling_code: "253" },
    { flag: "https://restcountries.eu/data/ecu.svg", name: "Ecuador", calling_code: "593" },
    { flag: "https://restcountries.eu/data/egy.svg", name: "Egypt", calling_code: "20" },
    { flag: "https://restcountries.eu/data/slv.svg", name: "El Salvador", calling_code: "503" },
    { flag: "https://restcountries.eu/data/gnq.svg", name: "Equatorial Guinea", calling_code: "240" },
    { flag: "https://restcountries.eu/data/eri.svg", name: "Eritrea", calling_code: "291" },
    { flag: "https://restcountries.eu/data/est.svg", name: "Estonia", calling_code: "372" },
    { flag: "https://restcountries.eu/data/eth.svg", name: "Ethiopia", calling_code: "251" },
    { flag: "https://restcountries.eu/data/flk.svg", name: "Falkland Islands (Malvinas)", calling_code: "500" },
    { flag: "https://restcountries.eu/data/fro.svg", name: "Faroe Islands", calling_code: "298" },
    { flag: "https://restcountries.eu/data/fji.svg", name: "Fiji", calling_code: "679" },
    { flag: "https://restcountries.eu/data/fin.svg", name: "Finland", calling_code: "358" },
    { flag: "https://restcountries.eu/data/fra.svg", name: "France", calling_code: "33" },
    { flag: "https://restcountries.eu/data/guf.svg", name: "French Guiana", calling_code: "594" },
    { flag: "https://restcountries.eu/data/pyf.svg", name: "French Polynesia", calling_code: "689" },
    { flag: "https://restcountries.eu/data/gab.svg", name: "Gabon", calling_code: "241" },
    { flag: "https://restcountries.eu/data/gmb.svg", name: "Gambia", calling_code: "220" },
    { flag: "https://restcountries.eu/data/geo.svg", name: "Georgia", calling_code: "995" },
    { flag: "https://restcountries.eu/data/deu.svg", name: "Germany", calling_code: "49" },
    { flag: "https://restcountries.eu/data/gha.svg", name: "Ghana", calling_code: "233" },
    { flag: "https://restcountries.eu/data/gib.svg", name: "Gibraltar", calling_code: "350" },
    { flag: "https://restcountries.eu/data/grc.svg", name: "Greece", calling_code: "30" },
    { flag: "https://restcountries.eu/data/grl.svg", name: "Greenland", calling_code: "299" },
    { flag: "https://restcountries.eu/data/glp.svg", name: "Guadeloupe", calling_code: "590" },
    { flag: "https://restcountries.eu/data/gtm.svg", name: "Guatemala", calling_code: "502" },
    { flag: "https://restcountries.eu/data/ggy.svg", name: "Guernsey", calling_code: "44" },
    { flag: "https://restcountries.eu/data/gin.svg", name: "Guinea", calling_code: "224" },
    { flag: "https://restcountries.eu/data/gnb.svg", name: "Guinea-Bissau", calling_code: "245" },
    { flag: "https://restcountries.eu/data/guy.svg", name: "Guyana", calling_code: "592" },
    { flag: "https://restcountries.eu/data/hti.svg", name: "Haiti", calling_code: "509" },
    { flag: "https://restcountries.eu/data/vat.svg", name: "Holy See", calling_code: "379" },
    { flag: "https://restcountries.eu/data/hnd.svg", name: "Honduras", calling_code: "504" },
    { flag: "https://restcountries.eu/data/hkg.svg", name: "Hong Kong", calling_code: "852" },
    { flag: "https://restcountries.eu/data/hun.svg", name: "Hungary", calling_code: "36" },
    { flag: "https://restcountries.eu/data/isl.svg", name: "Iceland", calling_code: "354" },
    { flag: "https://restcountries.eu/data/ind.svg", name: "India", calling_code: "91" },
    { flag: "https://restcountries.eu/data/idn.svg", name: "Indonesia", calling_code: "62" },
    { flag: "https://restcountries.eu/data/civ.svg", name: "Cote d'Ivoire", calling_code: "225" },
    { flag: "https://restcountries.eu/data/irn.svg", name: "Iran (Islamic Republic of)", calling_code: "98" },
    { flag: "https://restcountries.eu/data/irq.svg", name: "Iraq", calling_code: "964" },
    { flag: "https://restcountries.eu/data/irl.svg", name: "Ireland", calling_code: "353" },
    { flag: "https://restcountries.eu/data/imn.svg", name: "Isle of Man", calling_code: "44" },
    { flag: "https://restcountries.eu/data/isr.svg", name: "Israel", calling_code: "972" },
    { flag: "https://restcountries.eu/data/ita.svg", name: "Italy", calling_code: "39" },
    { flag: "https://restcountries.eu/data/jpn.svg", name: "Japan", calling_code: "81" },
    { flag: "https://restcountries.eu/data/jey.svg", name: "Jersey", calling_code: "44" },
    { flag: "https://restcountries.eu/data/jor.svg", name: "Jordan", calling_code: "962" },
    { flag: "https://restcountries.eu/data/ken.svg", name: "Kenya", calling_code: "254" },
    { flag: "https://restcountries.eu/data/kir.svg", name: "Kiribati", calling_code: "686" },
    { flag: "https://restcountries.eu/data/kwt.svg", name: "Kuwait", calling_code: "965" },
    { flag: "https://restcountries.eu/data/kgz.svg", name: "Kyrgyzstan", calling_code: "996" },
    { flag: "https://restcountries.eu/data/lao.svg", name: "Lao People's Democratic Republic", calling_code: "856" },
    { flag: "https://restcountries.eu/data/lva.svg", name: "Latvia", calling_code: "371" },
    { flag: "https://restcountries.eu/data/lbn.svg", name: "Lebanon", calling_code: "961" },
    { flag: "https://restcountries.eu/data/lso.svg", name: "Lesotho", calling_code: "266" },
    { flag: "https://restcountries.eu/data/lbr.svg", name: "Liberia", calling_code: "231" },
    { flag: "https://restcountries.eu/data/lby.svg", name: "Libya", calling_code: "218" },
    { flag: "https://restcountries.eu/data/lie.svg", name: "Liechtenstein", calling_code: "423" },
    { flag: "https://restcountries.eu/data/ltu.svg", name: "Lithuania", calling_code: "370" },
    { flag: "https://restcountries.eu/data/lux.svg", name: "Luxembourg", calling_code: "352" },
    { flag: "https://restcountries.eu/data/mac.svg", name: "Macao", calling_code: "853" },
    { flag: "https://restcountries.eu/data/mkd.svg", name: "Macedonia (the former Yugoslav Republic of)", calling_code: "389" },
    { flag: "https://restcountries.eu/data/mdg.svg", name: "Madagascar", calling_code: "261" },
    { flag: "https://restcountries.eu/data/mwi.svg", name: "Malawi", calling_code: "265" },
    { flag: "https://restcountries.eu/data/mys.svg", name: "Malaysia", calling_code: "60" },
    { flag: "https://restcountries.eu/data/mdv.svg", name: "Maldives", calling_code: "960" },
    { flag: "https://restcountries.eu/data/mli.svg", name: "Mali", calling_code: "223" },
    { flag: "https://restcountries.eu/data/mlt.svg", name: "Malta", calling_code: "356" },
    { flag: "https://restcountries.eu/data/mhl.svg", name: "Marshall Islands", calling_code: "692" },
    { flag: "https://restcountries.eu/data/mtq.svg", name: "Martinique", calling_code: "596" },
    { flag: "https://restcountries.eu/data/mrt.svg", name: "Mauritania", calling_code: "222" },
    { flag: "https://restcountries.eu/data/mus.svg", name: "Mauritius", calling_code: "230" },
    { flag: "https://restcountries.eu/data/myt.svg", name: "Mayotte", calling_code: "262" },
    { flag: "https://restcountries.eu/data/mex.svg", name: "Mexico", calling_code: "52" },
    { flag: "https://restcountries.eu/data/fsm.svg", name: "Micronesia (Federated States of)", calling_code: "691" },
    { flag: "https://restcountries.eu/data/mda.svg", name: "Moldova (Republic of)", calling_code: "373" },
    { flag: "https://restcountries.eu/data/mco.svg", name: "Monaco", calling_code: "377" },
    { flag: "https://restcountries.eu/data/mng.svg", name: "Mongolia", calling_code: "976" },
    { flag: "https://restcountries.eu/data/mne.svg", name: "Montenegro", calling_code: "382" },
    { flag: "https://restcountries.eu/data/mar.svg", name: "Morocco", calling_code: "212" },
    { flag: "https://restcountries.eu/data/moz.svg", name: "Mozambique", calling_code: "258" },
    { flag: "https://restcountries.eu/data/mmr.svg", name: "Myanmar", calling_code: "95" },
    { flag: "https://restcountries.eu/data/nam.svg", name: "Namibia", calling_code: "264" },
    { flag: "https://restcountries.eu/data/nru.svg", name: "Nauru", calling_code: "674" },
    { flag: "https://restcountries.eu/data/npl.svg", name: "Nepal", calling_code: "977" },
    { flag: "https://restcountries.eu/data/nld.svg", name: "Netherlands", calling_code: "31" },
    { flag: "https://restcountries.eu/data/ncl.svg", name: "New Caledonia", calling_code: "687" },
    { flag: "https://restcountries.eu/data/nzl.svg", name: "New Zealand", calling_code: "64" },
    { flag: "https://restcountries.eu/data/nic.svg", name: "Nicaragua", calling_code: "505" },
    { flag: "https://restcountries.eu/data/ner.svg", name: "Niger", calling_code: "227" },
    { flag: "https://restcountries.eu/data/nga.svg", name: "Nigeria", calling_code: "234" },
    { flag: "https://restcountries.eu/data/niu.svg", name: "Niue", calling_code: "683" },
    { flag: "https://restcountries.eu/data/nfk.svg", name: "Norfolk Island", calling_code: "672" },
    { flag: "https://restcountries.eu/data/prk.svg", name: "Korea (Democratic People's Republic of)", calling_code: "850" },
    { flag: "https://restcountries.eu/data/nor.svg", name: "Norway", calling_code: "47" },
    { flag: "https://restcountries.eu/data/omn.svg", name: "Oman", calling_code: "968" },
    { flag: "https://restcountries.eu/data/pak.svg", name: "Pakistan", calling_code: "92" },
    { flag: "https://restcountries.eu/data/plw.svg", name: "Palau", calling_code: "680" },
    { flag: "https://restcountries.eu/data/pse.svg", name: "Palestine, State of", calling_code: "970" },
    { flag: "https://restcountries.eu/data/pan.svg", name: "Panama", calling_code: "507" },
    { flag: "https://restcountries.eu/data/png.svg", name: "Papua New Guinea", calling_code: "675" },
    { flag: "https://restcountries.eu/data/pry.svg", name: "Paraguay", calling_code: "595" },
    { flag: "https://restcountries.eu/data/per.svg", name: "Peru", calling_code: "51" },
    { flag: "https://restcountries.eu/data/phl.svg", name: "Philippines", calling_code: "63" },
    { flag: "https://restcountries.eu/data/pcn.svg", name: "Pitcairn", calling_code: "64" },
    { flag: "https://restcountries.eu/data/pol.svg", name: "Poland", calling_code: "48" },
    { flag: "https://restcountries.eu/data/prt.svg", name: "Portugal", calling_code: "351" },
    { flag: "https://restcountries.eu/data/qat.svg", name: "Qatar", calling_code: "974" },
    { flag: "https://restcountries.eu/data/kos.svg", name: "Republic of Kosovo", calling_code: "383" },
    { flag: "https://restcountries.eu/data/reu.svg", name: "Reunion", calling_code: "262" },
    { flag: "https://restcountries.eu/data/rou.svg", name: "Romania", calling_code: "40" },
    { flag: "https://restcountries.eu/data/rus.svg", name: "Russian Federation", calling_code: "7" },
    { flag: "https://restcountries.eu/data/rwa.svg", name: "Rwanda", calling_code: "250" },
    { flag: "https://restcountries.eu/data/blm.svg", name: "Saint Barthelemy", calling_code: "590" },
    { flag: "https://restcountries.eu/data/shn.svg", name: "Saint Helena, Ascension and Tristan da Cunha", calling_code: "290" },
    { flag: "https://restcountries.eu/data/maf.svg", name: "Saint Martin (French part)", calling_code: "590" },
    { flag: "https://restcountries.eu/data/spm.svg", name: "Saint Pierre and Miquelon", calling_code: "508" },
    { flag: "https://restcountries.eu/data/wsm.svg", name: "Samoa", calling_code: "685" },
    { flag: "https://restcountries.eu/data/smr.svg", name: "San Marino", calling_code: "378" },
    { flag: "https://restcountries.eu/data/stp.svg", name: "Sao Tome and Principe", calling_code: "239" },
    { flag: "https://restcountries.eu/data/sau.svg", name: "Saudi Arabia", calling_code: "966" },
    { flag: "https://restcountries.eu/data/sen.svg", name: "Senegal", calling_code: "221" },
    { flag: "https://restcountries.eu/data/srb.svg", name: "Serbia", calling_code: "381" },
    { flag: "https://restcountries.eu/data/syc.svg", name: "Seychelles", calling_code: "248" },
    { flag: "https://restcountries.eu/data/sle.svg", name: "Sierra Leone", calling_code: "232" },
    { flag: "https://restcountries.eu/data/sgp.svg", name: "Singapore", calling_code: "65" },
    { flag: "https://restcountries.eu/data/svk.svg", name: "Slovakia", calling_code: "421" },
    { flag: "https://restcountries.eu/data/svn.svg", name: "Slovenia", calling_code: "386" },
    { flag: "https://restcountries.eu/data/slb.svg", name: "Solomon Islands", calling_code: "677" },
    { flag: "https://restcountries.eu/data/som.svg", name: "Somalia", calling_code: "252" },
    { flag: "https://restcountries.eu/data/zaf.svg", name: "South Africa", calling_code: "27" },
    { flag: "https://restcountries.eu/data/sgs.svg", name: "South Georgia and the South Sandwich Islands", calling_code: "500" },
    { flag: "https://restcountries.eu/data/kor.svg", name: "Korea (Republic of)", calling_code: "82" },
    { flag: "https://restcountries.eu/data/ssd.svg", name: "South Sudan", calling_code: "211" },
    { flag: "https://restcountries.eu/data/esp.svg", name: "Spain", calling_code: "34" },
    { flag: "https://restcountries.eu/data/lka.svg", name: "Sri Lanka", calling_code: "94" },
    { flag: "https://restcountries.eu/data/sdn.svg", name: "Sudan", calling_code: "249" },
    { flag: "https://restcountries.eu/data/sur.svg", name: "Suriname", calling_code: "597" },
    { flag: "https://restcountries.eu/data/swz.svg", name: "Swaziland", calling_code: "268" },
    { flag: "https://restcountries.eu/data/swe.svg", name: "Sweden", calling_code: "46" },
    { flag: "https://restcountries.eu/data/che.svg", name: "Switzerland", calling_code: "41" },
    { flag: "https://restcountries.eu/data/syr.svg", name: "Syrian Arab Republic", calling_code: "963" },
    { flag: "https://restcountries.eu/data/twn.svg", name: "Taiwan", calling_code: "886" },
    { flag: "https://restcountries.eu/data/tjk.svg", name: "Tajikistan", calling_code: "992" },
    { flag: "https://restcountries.eu/data/tza.svg", name: "Tanzania, United Republic of", calling_code: "255" },
    { flag: "https://restcountries.eu/data/tha.svg", name: "Thailand", calling_code: "66" },
    { flag: "https://restcountries.eu/data/tls.svg", name: "Timor-Leste", calling_code: "670" },
    { flag: "https://restcountries.eu/data/tgo.svg", name: "Togo", calling_code: "228" },
    { flag: "https://restcountries.eu/data/tkl.svg", name: "Tokelau", calling_code: "690" },
    { flag: "https://restcountries.eu/data/ton.svg", name: "Tonga", calling_code: "676" },
    { flag: "https://restcountries.eu/data/tun.svg", name: "Tunisia", calling_code: "216" },
    { flag: "https://restcountries.eu/data/tur.svg", name: "Turkey", calling_code: "90" },
    { flag: "https://restcountries.eu/data/tkm.svg", name: "Turkmenistan", calling_code: "993" },
    { flag: "https://restcountries.eu/data/tuv.svg", name: "Tuvalu", calling_code: "688" },
    { flag: "https://restcountries.eu/data/uga.svg", name: "Uganda", calling_code: "256" },
    { flag: "https://restcountries.eu/data/ukr.svg", name: "Ukraine", calling_code: "380" },
    { flag: "https://restcountries.eu/data/are.svg", name: "United Arab Emirates", calling_code: "971" },
    { flag: "https://restcountries.eu/data/gbr.svg", name: "United Kingdom of Great Britain and Northern Ireland", calling_code: "44" },
    { flag: "https://restcountries.eu/data/usa.svg", name: "United States of America", calling_code: "1" },
    { flag: "https://restcountries.eu/data/ury.svg", name: "Uruguay", calling_code: "598" },
    { flag: "https://restcountries.eu/data/uzb.svg", name: "Uzbekistan", calling_code: "998" },
    { flag: "https://restcountries.eu/data/vut.svg", name: "Vanuatu", calling_code: "678" },
    { flag: "https://restcountries.eu/data/ven.svg", name: "Venezuela (Bolivarian Republic of)", calling_code: "58" },
    { flag: "https://restcountries.eu/data/vnm.svg", name: "Viet Nam", calling_code: "84" },
    { flag: "https://restcountries.eu/data/wlf.svg", name: "Wallis and Futuna", calling_code: "681" },
    { flag: "https://restcountries.eu/data/esh.svg", name: "Western Sahara", calling_code: "212" },
    { flag: "https://restcountries.eu/data/yem.svg", name: "Yemen", calling_code: "967" },
    { flag: "https://restcountries.eu/data/zmb.svg", name: "Zambia", calling_code: "260" },
    { flag: "https://restcountries.eu/data/zwe.svg", name: "Zimbabwe", calling_code: "263" },
]),
    ...
    (function ($) {
        let methods = {
            init: function () {
                return this.data("paymentform", new PaymentForm(this)), this;
            },
            card: function () {
        ...
        $.fn.PaymentForm = function (methodOrOptions) {
            return methods[methodOrOptions]
                ...
                ? void $.error("Method " + methodOrOptions + " does not exist on jQuery.Payment")
    ...
    (PaymentForm.KEYS = { 0: 48, 9: 57, NUMPAD_0: 96, NUMPAD_9: 105, DELETE: 46, BACKSPACE: 8, ARROW_LEFT: 37, ARROW_RIGHT: 39, ARROW_UP: 38, ARROW_DOWN: 40, HOME: 36, END: 35, TAB: 9, A: 65, X: 88, C: 67, V: 86 }),
    ...
    (PaymentForm.OTP_EXPLICATION_ADD = "Escogiendo esta opción se va a generar una Clave Temporal única, con la que validarás tu tarjeta. Haz clic en “Guardar” para continuar con el proceso."),
    (PaymentForm.OTP_EXPLICATION_CHECKOUT = "Escogiendo esta opción se va a generar una Clave Temporal única, con la que validarás tu compra."),
    ...
    (PaymentForm.keyIsKeyboardCommand = function (e) {
        let keyCode = PaymentForm.keyCodeFromEvent(e);
        return PaymentForm.keyIsCommandFromEvent(e) && (keyCode === PaymentForm.KEYS.A || keyCode === PaymentForm.KEYS.X || keyCode === PaymentForm.KEYS.C || keyCode === PaymentForm.KEYS.V);
    }),
    ...
    (PaymentForm.prototype.showVerification = function (objResponse, successCallback, errorCallback) {
        (this.addCardProcess = { response: objResponse, successAddCardCallback: successCallback, errorAddCardCallback: errorCallback }),
    ...
    (PaymentForm.prototype.verifyTransaction = function () {
        ...
        let user_id = this.addCardProcess.response.user.id,
            transaction_id = this.addCardProcess.response.card.transaction_reference,
        ...
        Payment.verifyTransaction(
            ...
            function (response) {
                if (
                    ...
                    ($this.addCardProcess.response.transaction = $this.addCardProcess.response.transaction ? response.transaction : void 0),
                    "pending" === response.transaction.status)
                )
                ...
                "success" === response.transaction.status
                    ? ($this.addCardProcess.response.card.status = "valid")
                    : (($this.addCardProcess.response.card.status = "rejected"), ($this.addCardProcess.response.card.message = response.transaction.message)),
                    $this.addCardProcess.successAddCardCallback($this.addCardProcess.response);
            },
            function (response) {
                $this.unBlockVerificationContainer(), $this.removeVerificationContainer(), $this.addCardProcess.errorAddCardCallback($this.addCardProcess.response);
            }
        );
    }),
    (PaymentForm.prototype.cardTypeFromNumberBin = function (number) {
        let number_bin = number.replace(" ", "").substring(0, 6);
        number >= 6 && this.numberBin !== number_bin && ((this.numberBin = number_bin), Payment.getBinInformation(number_bin, this, this.successBinCallback, function (error) {}));
    }),
    (PaymentForm.prototype.setRequiredFields = function (required_fields) {
        const form = this;
        if (!(required_fields && required_fields.length > 0)) return form.removeFiscalNumber(), void form.removeNip();
        required_fields.forEach(function (required_field) {
            switch ("object" == typeof required_field ? Object.keys(required_field)[0] : required_field) {
                case "fiscal_number":
    ...
    (PaymentForm.prototype.setNoRequiredFields = function (no_required_fields) {
        const form = this;
        if (!(no_required_fields && no_required_fields.length > 0)) return form.addExpiryContainer(), void form.addCvcContainer();
        no_required_fields.forEach(function (no_required_field) {
            switch ("object" == typeof no_required_field ? Object.keys(no_required_field)[0] : no_required_field) {
    ...
    (PaymentForm.prototype.successBinCallback = function (objResponse, form) {
        if (
            ...
            objResponse.installments_options && objResponse.installments_options.length > 0 && form.setInstallmentsOptions(objResponse.installments_options),
            ...
            form.exclusiveTypes.forEach(function (type) {
                form.cardType === type && (is_valid_type = !0);
            }),
                is_valid_type ? is_valid_type && form.isBlocked && form.unBlockForm() : form.blockForm();
        }
    }),
    ...
    (PaymentForm.filterNumberOnlyKey = function (e) {
        let isNumber = PaymentForm.keyIsNumber(e),
            isDeletion = PaymentForm.keyIsDeletion(e),
            isArrow = PaymentForm.keyIsArrow(e),
            isNavigation = PaymentForm.keyIsNavigation(e),
            isKeyboardCommand = PaymentForm.keyIsKeyboardCommand(e),
            isTab = PaymentForm.keyIsTab(e);
    ...
    (PaymentForm.digitFromKeyCode = function (keyCode) {
        return keyCode >= PaymentForm.KEYS[0] && keyCode <= PaymentForm.KEYS[9] ? keyCode - PaymentForm.KEYS[0] : keyCode >= PaymentForm.KEYS.NUMPAD_0 && keyCode <= PaymentForm.KEYS.NUMPAD_9 ? keyCode - PaymentForm.KEYS.NUMPAD_0 : null;
    }),
    (PaymentForm.handleMaskedNumberInputKey = function (e, mask) {
        PaymentForm.filterNumberOnlyKey(e);
        let keyCode = e.which || e.keyCode,
            element = e.target,
            caretStart = PaymentForm.caretStartPosition(element),
            caretEnd = PaymentForm.caretEndPosition(element),
            normalisedStartCaretPosition = PaymentForm.normaliseCaretPosition(mask, caretStart),
            normalisedEndCaretPosition = PaymentForm.normaliseCaretPosition(mask, caretEnd),
            newCaretPosition = caretStart,
            isNumber = PaymentForm.keyIsNumber(e),
            isDelete = PaymentForm.keyIsDelete(e),
            isBackspace = PaymentForm.keyIsBackspace(e);
        if (isNumber || isDelete || isBackspace) {
            e.preventDefault();
            let rawText = $(element).val(),
                numbersOnly = PaymentForm.numbersOnlyString(rawText),
                digit = PaymentForm.digitFromKeyCode(keyCode),
            ...
            rangeHighlighted && (numbersOnly = numbersOnly.slice(0, normalisedStartCaretPosition) + numbersOnly.slice(normalisedEndCaretPosition)),
                caretStart !== mask.length &&
                    (isNumber &&
                        ...
                        (newCaretPosition = Math.max(PaymentForm.denormaliseCaretPosition(mask, normalisedStartCaretPosition + 1), PaymentForm.denormaliseCaretPosition(mask, normalisedStartCaretPosition + 2) - 1))),
    ...
    (PaymentForm.prototype.refreshFiscalNumberValidation = function () {
        return this.fiscalNumberAdded() && this.isFiscalNumberValid()
            ? (this.fiscalNumberInput.parent().removeClass("has-error"), !0)
            : !(this.fiscalNumberAdded() && !this.isFiscalNumberValid()) || (this.fiscalNumberInput.parent().addClass("has-error"), !1);
    }),
    ...
    (PaymentForm.prototype.refreshValidationOption = function () {
        this.getValidationOption() === PaymentForm.AUTH_OTP
            ? (this.addValidationMessage(), this.removeNip(), this.removeVirtualKeyboard())
            : this.getValidationOption() === PaymentForm.AUTH_NIP && (this.removeValidationMessage(), this.addNip());
    }),
    (PaymentForm.prototype.refreshVerificationInputValidation = function () {
        return this.isVerificationValueValid()
            ? (this.verificationInput.parent().removeClass("has-error"), this.verificationBtn.removeAttr("disabled"), !0)
            : (this.verificationInput.parent().addClass("has-error"), this.verificationBtn.attr("disabled", "disabled"), !1);
    }),
    (PaymentForm.prototype.addValueToNip = function (value, key) {
        if (this.nipWrapperAdded() && this.nipInput.val().length < this.nipLenght) {
            ...
            this.nipInput.val(newValue), (this.nip = this.nip + key);
        }
    }),
    ...
    (PaymentForm.prototype.isCvcValid = function () {
        return this.getValidationOption() !== PaymentForm.AUTH_CVC || (null != this.getCvc() && this.getCvc().trim().length === this.cvcLenght);
    }),
    ...
    (PaymentForm.prototype.isCellPhoneValid = function () {
        return !this.captureCellPhone || (null != this.getCellPhone() && this.getCellPhone().length >= 7);
    }),
    (PaymentForm.prototype.isCardNumberValid = function () {
        let value = this.getCardNumber();
        if (!this.useLunh) return !0;
        if ("" === value) return !1;
        if (/[^0-9-\s]+/.test(value)) return !1;
        let nCheck = 0,
            bEven = !1;
        for (let n = (value = value.replace(/\D/g, "")).length - 1; n >= 0; n--) {
    ...
    (PaymentForm.prototype.isNipValid = function () {
        return this.getValidationOption() !== PaymentForm.AUTH_NIP || (null != this.getNip() && this.getNip().trim().length === this.nipLenght);
    }),
    ...
    (PaymentForm.prototype.isVerificationValueValid = function () {
        return !this.verificationContainerAdded() || (null != this.getVerificationValue() && this.getVerificationValue().trim().length === this.verificationLenght);
    }),
    ...
    (PaymentForm.prototype.warningMessageAdded = function () {
        return this.elem.find(".warning-message").length >= 1;
    }),
    (PaymentForm.prototype.verificationContainerAdded = function () {
        return this.elem.find(".verification-container").length >= 1;
    }),
    (PaymentForm.prototype.getCard = function () {
        ...
        if (this.isValidData()) {
            ...
            2 === ("" + year).length && (year = currentYear.substring(0, 2) + "" + this.getExpiryYear()),
                (data = {
                    card: {
    ...
    (PaymentForm.prototype.getValidationOption = function () {
        ...
        return this.nipWrapperAdded() && (val = PaymentForm.AUTH_NIP), val;
    }),
    (PaymentForm.prototype.getCvc = function () {
        return this.getValidationOption() === PaymentForm.AUTH_CVC ? this.cvcInput.val() : "";
    }),
    (PaymentForm.prototype.getNip = function () {
        return this.getValidationOption() === PaymentForm.AUTH_NIP ? (this.nipWrapperAdded() && !this.USE_VIRTUAL_KEYBOARD && (this.nip = this.nipInput.val()), this.nip) : "";
    }),
    (PaymentForm.prototype.getVerificationValue = function () {
        return this.verificationContainerAdded() ? this.verificationInput.val() : "";
    }),
    (PaymentForm.prototype.blockForm = function () {
        (this.isBlocked = !0),
            ...
            this.EXPIRY_USE_DROPDOWNS
                ? (this.expiryMonthInput.val(""), this.expiryMonthInput.attr("disabled", "disabled"), this.expiryYearInput.val(""), this.expiryYearInput.attr("disabled", "disabled"))
                : (this.expiryMonthYearInput.val(""), this.expiryMonthYearInput.attr("disabled", "disabled")),
            this.cvcInput.val(""),
            this.cvcInput.attr("disabled", "disabled"),
            this.fiscalNumberAdded() && (this.fiscalNumberInput.val(""), this.fiscalNumberInput.attr("disabled", "disabled")),
            this.nipWrapperAdded() && (this.cleanNipInput(), this.nipInput.attr("disabled", "disabled")),
    ...
    (PaymentForm.prototype.unBlockForm = function () {
        (this.isBlocked = !1),
            ...
            this.EXPIRY_USE_DROPDOWNS ? (this.expiryMonthInput.removeAttr("disabled"), this.expiryYearInput.removeAttr("disabled")) : this.expiryMonthYearInput.removeAttr("disabled"),
            this.cvcInput.removeAttr("disabled"),
            this.fiscalNumberAdded() && this.fiscalNumberInput.removeAttr("disabled"),
            this.nipWrapperAdded() && (this.cleanNipInput(), this.nipInput.removeAttr("disabled")),
    ...
    (PaymentForm.prototype.refreshCreditCardNumberFormat = function () {
        let numbersOnly = PaymentForm.numbersOnlyString($(this.cardNumberInput).val()),
            formattedNumber = PaymentForm.applyFormatMask(numbersOnly, this.creditCardNumberMask);
    ...
    (PaymentForm.prototype.refreshExpiryMonthYearInput = function () {
        let numbersOnly = PaymentForm.numbersOnlyString($(this.expiryMonthYearInput).val()),
            formattedNumber = PaymentForm.applyFormatMask(numbersOnly, PaymentForm.EXPIRY_MASK);
    ...
    (PaymentForm.prototype.refreshCellPhoneFormat = function () {
        let numbersOnly = PaymentForm.numbersOnlyString($(this.cellPhoneInput).val()),
            formattedNumber = PaymentForm.applyFormatMask(numbersOnly, PaymentForm.CELLPHONE_MASK);
    ...
    (PaymentForm.prototype.addNip = function () {
        this.otpWrapperAdded()
            ? this.getValidationOption() !== PaymentForm.AUTH_NIP || this.nipWrapperAdded() || (this.initNipInput(), this.setupNipInput(), this.setIconColour(this.iconColour))
            : this.nipWrapperAdded() || (this.initNipInput(), this.setupNipInput(), this.setIconColour(this.iconColour));
    }),
    ...
    (PaymentForm.prototype.addVirtualKeyboard = function () {
        this.virtualKeyboardAdded() || this.getValidationOption() !== PaymentForm.AUTH_NIP || this.setupVirtualKeyboard();
    }),
    ...
    (PaymentForm.prototype.addWarningMessage = function () {
        this.warningMessageAdded() || this.setupWarningMessage();
    }),
    (PaymentForm.prototype.removeWarningMessage = function () {
        this.warningMessageAdded() && this.elem.find(".warning-message").remove();
    }),
    (PaymentForm.prototype.addVerificationContainer = function () {
        this.verificationContainerAdded() ||
            (this.cardNumberInput.attr("disabled", "disabled"),
            this.emailInput.attr("disabled", "disabled"),
            this.cellPhoneInput.attr("disabled", "disabled"),
            this.nameInput.attr("disabled", "disabled"),
            this.cvcInput.attr("disabled", "disabled"),
            this.EXPIRY_USE_DROPDOWNS ? (this.expiryMonthInput.attr("disabled", "disabled"), this.expiryYearInput.attr("disabled", "disabled")) : this.expiryMonthYearInput.attr("disabled", "disabled"),
            this.fiscalNumberAdded() && this.fiscalNumberInput.attr("disabled", "disabled"),
            this.nipWrapperAdded() && this.nipInput.attr("disabled", "disabled"),
    ...
    (PaymentForm.prototype.blockVerificationContainer = function () {
        this.verificationContainerAdded() && (this.verificationInput.attr("disabled", "disabled"), this.verificationBtn.attr("disabled", "disabled"));
    }),
    (PaymentForm.prototype.unBlockVerificationContainer = function () {
        this.verificationContainerAdded() &&
            ...
            this.EXPIRY_USE_DROPDOWNS ? (this.expiryMonthInput.removeAttr("disabled"), this.expiryYearInput.removeAttr("disabled")) : this.expiryMonthYearInput.removeAttr("disabled"),
            this.fiscalNumberAdded() && this.fiscalNumberInput.removeAttr("disabled"),
            this.nipWrapperAdded() && this.nipInput.removeAttr("disabled"),
    ...
    (PaymentForm.prototype.removeVerificationContainer = function () {
        this.verificationContainerAdded() && (this.removeWarningMessage(), this.elem.find(".verification-container").remove());
    }),
    (PaymentForm.prototype.initCardNumberInput = function () {
        (this.cardNumberInput = PaymentForm.detachOrCreateElement(this.elem, ".card-number", "<input class='card-number' />")),
            PaymentForm.elementHasAttribute(this.cardNumberInput, "name") || this.cardNumberInput.attr("name", "card-number"),
            PaymentForm.elementHasAttribute(this.cardNumberInput, "placeholder") || this.cardNumberInput.attr("placeholder", PaymentForm.CREDIT_CARD_NUMBER_PLACEHOLDER),
    ...
    (PaymentForm.prototype.initNameInput = function () {
        this.captureName || (this.captureName = null != this.elem.find(".name")[0]),
            (this.nameInput = PaymentForm.detachOrCreateElement(this.elem, ".name", "<input class='name' />")),
            PaymentForm.elementHasAttribute(this.nameInput, "name") || this.nameInput.attr("name", "card-holder"),
            PaymentForm.elementHasAttribute(this.nameInput, "placeholder") || this.nameInput.attr("placeholder", PaymentForm.NAME_PLACEHOLDER);
    }),
    (PaymentForm.prototype.initEmailInput = function () {
        this.captureEmail || (this.captureEmail = null != this.elem.find(".email")[0]),
            (this.emailInput = PaymentForm.detachOrCreateElement(this.elem, ".email", "<input class='email' />")),
            PaymentForm.elementHasAttribute(this.emailInput, "name") || this.emailInput.attr("name", "email"),
            PaymentForm.elementHasAttribute(this.emailInput, "placeholder") || this.emailInput.attr("placeholder", PaymentForm.EMAIL_PLACEHOLDER),
    ...
    (PaymentForm.prototype.initCellPhoneInput = function () {
        this.captureCellPhone || (this.captureCellPhone = null != this.elem.find(".cellphone")[0]),
            ...
            PaymentForm.elementHasAttribute(this.cellPhoneInput, "name") || this.cellPhoneInput.attr("name", "cellphone"),
            PaymentForm.elementHasAttribute(this.cellphoneCountryCodeInput, "name") || this.cellphoneCountryCodeInput.attr("name", "cellphone-country-code"),
            PaymentForm.elementHasAttribute(this.cellPhoneInput, "placeholder") || this.cellPhoneInput.attr("placeholder", PaymentForm.CELLPHONE_PLACEHOLDER),
        ...
        Payment.COUNTRIES.forEach(function (country) {
            ...
            (option.value = country.calling_code), (option.text = country.name), $this.cellphoneCountryCodeInput.append(option);
        });
    }),
    ...
    (PaymentForm.prototype.initCvcInput = function () {
        (this.cvcInput = PaymentForm.detachOrCreateElement(this.elem, ".cvc", "<input class='cvc' />")),
            PaymentForm.elementHasAttribute(this.cvcInput, "placeholder") || this.cvcInput.attr("placeholder", PaymentForm.CVC_PLACEHOLDER),
            ...
            this.IS_MOBILE || this.cvcInput.attr("type", "password");
    }),
    (PaymentForm.prototype.initFiscalNumberInput = function () {
        (this.fiscalNumberInput = PaymentForm.detachOrCreateElement(this.elem, ".fiscal-number", "<input class='fiscal-number' />")),
            PaymentForm.elementHasAttribute(this.fiscalNumberInput, "name") || this.fiscalNumberInput.attr("name", "fiscal-number"),
            PaymentForm.elementHasAttribute(this.fiscalNumberInput, "placeholder") || this.fiscalNumberInput.attr("placeholder", PaymentForm.FISCAL_NUMBER_PLACEHOLDER),
    ...
    (PaymentForm.prototype.initNipInput = function () {
        (this.nipInput = PaymentForm.detachOrCreateElement(this.elem, ".nip", "<input class='nip' />")),
            PaymentForm.elementHasAttribute(this.nipInput, "placeholder") || this.nipInput.attr("placeholder", PaymentForm.NIP_PLACEHOLDER),
            ...
            this.USE_VIRTUAL_KEYBOARD && (this.nipInput.attr("readonly", "true"), this.nipInput.attr("type", "password"));
    }),
    (PaymentForm.prototype.initOtpValidation = function () {
        (this.otpValidation = PaymentForm.detachOrCreateElement(this.elem, ".otp", "<input class='otp' />")), this.otpValidation.attr("type", "checkbox"), this.otpValidation.attr("id", "otp-option");
    }),
    (PaymentForm.prototype.initOtpValidation = function () {
    ...
    (PaymentForm.prototype.initVerificationInput = function () {
        (this.verificationInput = PaymentForm.detachOrCreateElement(this.elem, ".verification", "<input class='verification' />")),
            PaymentForm.elementHasAttribute(this.verificationInput, "placeholder") || this.verificationInput.attr("placeholder", PaymentForm.VERIFICATION_PLACEHOLDER),
    ...
    (PaymentForm.prototype.setupCardNumberInput = function () {
        ...
        wrapper.append(this.cardNumberInput), wrapper.append("<div class='card-type-icon'></div>"), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.CREDIT_CARD_SVG);
        let $this = this;
    ...
    (PaymentForm.prototype.setupNameInput = function () {
        if (this.captureName) {
            ...
            wrapper.append(this.nameInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.USER_SVG);
            let $this = this;
    ...
    (PaymentForm.prototype.setupEmailInput = function () {
        if (this.captureEmail) {
            ...
            wrapper.append(this.emailInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.MAIL_SVG);
            let $this = this;
        ...
        if (this.captureCellPhone) {
            ...
            this.cellPhoneInput.keydown(function (e) {
                ...
                this.cellPhoneInput.blur(function () {
                    $this.refreshCellPhoneFormat(), $this.refreshCellPhoneValidation();
                }),
    ...
    (PaymentForm.prototype.setupExpiryInput = function () {
        ...
        if (this.EXPIRY_USE_DROPDOWNS) {
            ...
            PaymentForm.copyAllElementAttributes(expiryMonthOld, expiryMonthNew), this.expiryMonthInput.remove(), (this.expiryMonthInput = expiryMonthNew);
            ...
            for (let i = 0; i < PaymentForm.EXPIRY_NUMBER_OF_YEARS; i++) expiryYearNew.append("<option value='" + currentYear + "'>" + currentYear + "</option>"), (currentYear = (currentYear + 1) % 100);
            let expiryYearOld = this.expiryYearInput;
            PaymentForm.copyAllElementAttributes(expiryYearOld, expiryYearNew), this.expiryYearInput.remove(), (this.expiryYearInput = expiryYearNew), expiryInput.append(this.expiryMonthInput), expiryInput.append(this.expiryYearInput);
        } else {
            (expiryInput = $("<div></div>")),
                ...
                PaymentForm.elementHasAttribute(this.expiryMonthYearInput, "placeholder") || this.expiryMonthYearInput.attr("placeholder", PaymentForm.EXPIRY_PLACEHOLDER),
            ...
            this.expiryMonthYearInput.keydown(function (e) {
                ...
                1 === val.length && parseInt(val) > 1 && PaymentForm.keyIsNumber(e) && $this.expiryMonthYearInput.val(PaymentForm.applyFormatMask("0" + val, PaymentForm.EXPIRY_MASK)),
        ...
        wrapper.append(expiryInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.CALENDAR_SVG);
    }),
    (PaymentForm.prototype.setupCvcInput = function () {
        ...
        wrapper.append(this.cvcInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.LOCK_SVG);
        let $this = this;
    ...
    (PaymentForm.prototype.setupFiscalNumberInput = function () {
        ...
        wrapper.append(this.fiscalNumberInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.USER_SVG);
        let $this = this;
    ...
    (PaymentForm.prototype.setupNipInput = function () {
        ...
        wrapper.append(this.nipInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.LOCK_SVG);
        let $this = this;
    ...
    (PaymentForm.prototype.setupOtpValidation = function () {
        let wrapper = PaymentForm.detachOrCreateElement(this.elem, ".otp-wrapper", "<div class='otp-wrapper'></div>"),
            label = PaymentForm.detachOrCreateElement(this.elem, ".otp-label", "<label class='otp-label'></label>");
        label.attr("for", "otp-option"),
            Payment.IS_CHECKOUT ? label.append(PaymentForm.OTP_PLACEHOLDER_CHECKOUT) : label.append(PaymentForm.OTP_PLACEHOLDER_ADD),
    ...
    (PaymentForm.prototype.setupVirtualKeyboard = function () {
        let array = PaymentForm.generateRandoms(),
            beforeWrapper = this.elem.find(".nip-wrapper");
        this.USE_OTP && (beforeWrapper = this.elem.find(".otp-wrapper"));
    ...
    (PaymentForm.prototype.setupValidationMessage = function () {
        ...
        wrapper.addClass("payment_dialog_success"), Payment.IS_CHECKOUT ? wrapper.text(PaymentForm.OTP_EXPLICATION_CHECKOUT) : wrapper.text(PaymentForm.OTP_EXPLICATION_ADD), (this.validationMessage = wrapper), this.elem.append(wrapper);
    }),
    (PaymentForm.prototype.setupWarningMessage = function () {
        ...
        wrapper.addClass("payment_dialog_warning"), this.invalidCardTypeMessage ? wrapper.text(this.invalidCardTypeMessage) : wrapper.text(PaymentForm.INVALID_CARD_TYPE_MESSAGE), (this.warningMessage = wrapper), this.elem.append(wrapper);
    }),
    (PaymentForm.prototype.setupVerificationInput = function () {
        this.elem.append("<div class='verification-container'><div class='verification-wrapper'></div><div class='verification-btn-wrapper'></div></div>"), this.elem.find(".verification-btn-wrapper").append(this.verificationBtn);
        let wrapper = this.elem.find(".verification-wrapper");
        wrapper.append(this.verificationInput), wrapper.append("<div class='icon'></div>"), wrapper.find(".icon").append(PaymentForm.LOCK_SVG);
        let $this = this;
    ...
    (PaymentForm.prototype.refreshExpiryMonthValidation = function () {
        return !this.expiryContainerAdded() || (PaymentForm.isExpiryValid(this.getExpiryMonth(), this.getExpiryYear()) ? (this.setExpiryMonthAsValid(), !0) : (this.setExpiryMonthAsInvalid(), !1));
    }),
    ...
    (PaymentForm.isExpiryValid = function (month, year) {
        ...
        return (
            ...
            (year = parseInt(year)),
            PaymentForm.isValidMonth(month) && (year > currentYear || (year === currentYear && month >= currentMonth))
        );
    }),
...
function _getTime(callback) {
    ...
    (xhr.onload = function () {
        ...
        } else AUTH_TIMESTAMP_SERVER = String(new Date().getTime());
        callback();
    }),
        ["local", "dev", "stg"].indexOf(Payment.ENV_MODE) >= 0 ? xhr.open("GET", Payment.PG_MICROS_STAGING) : ["prod", "prod-qa"].indexOf(Payment.ENV_MODE) >= 0 && xhr.open("GET", Payment.PG_MICROS_PRODUCTION),
        xhr.send();
}
function Payment() {}
(Payment.uuidv4 = function () {
                            ...
                            try {
                                ...
                                200 === xmlhttp.status
                                    ? "pending" === objResponse.card.status && void 0 !== payment_form
                                        ? ((objResponse.user = { id: createTokenRequest.user.id }), payment_form.PaymentForm("showVerification", objResponse, successCallback, errorCallback))
                                        : successCallback(objResponse)
                                    : errorCallback(objResponse);
                            } catch (e) {
                                errorCallback({ error: { type: "Server Error", help: "Server Error", description: "Server Error" } });
                            }
                    }),
    ...
    (Payment.dataCollector = function (session_id) {
        ...
        if (
            ((Payment.KOUNT_ENVIRONMENT = "prod" === Payment.ENV_MODE ? Payment.KOUN_PROD_ENVIRONMENT : Payment.KOUN_TEST_ENVIRONMENT),
            (Payment.TDS_2 = {
                threeDS2_data: { term_url: "https://example.com", device_type: "browser" },
                browser_info: {
                    ip: "127.0.0.1",
            ...
            "undefined" == typeof document || void 0 === document.body || !document.body || ("interactive" !== document.readyState && "complete" !== document.readyState))
        )
            ...
            (body = document.getElementsByTagName("body")[0]),
                (iframe = document.createElement("iframe")).setAttribute("id", "riskIframe"),
                iframe.setAttribute("height", "1"),
                iframe.setAttribute("scrolling", "no"),
                iframe.setAttribute("frameborder", "0"),
                iframe.setAttribute("width", "1"),
                iframe.setAttribute("src", kount_url),
                (image = document.createElement("img")).setAttribute("height", "1"),
    ...
    (Payment.setEnvironment = function (test_mode, payment_client_app_code, payment_client_app_key) {
        (Payment.TEST_MODE = test_mode), (Payment.PAYMENT_CLIENT_APP_CODE = payment_client_app_code), (Payment.PAYMENT_CLIENT_APP_KEY = payment_client_app_key);
    }),
    (Payment.init = function (env_mode, payment_client_app_code, payment_client_app_key) {
        (Payment.ENV_MODE = env_mode), (Payment.PAYMENT_CLIENT_APP_CODE = payment_client_app_code), (Payment.PAYMENT_CLIENT_APP_KEY = payment_client_app_key);
    }),
    (Payment.addCard = function (uid, email, card, success_callback, failure_callback, payment_form) {
        const session_id = Payment.getSessionId();
        Payment.dataCollector(session_id);
        let params = {
            session_id: session_id,
            user: { id: uid, email: email, phone: payment_form ? payment_form.PaymentForm("cellPhone") : $(".cellphone").val(), fiscal_number: payment_form ? payment_form.PaymentForm("fiscalNumber") : $(".fiscal-number").val() },
            card: card.card,
    ...
    (Payment.getBinInformation = function (number_bin, form, successCallback, errorCallback) {
        const initFunction = function () {
            ...
            if (this.IS_CHECKOUT) {
                ...
                let url_bin = this.getServerURL() + "/v2/card_bin/" + number_bin;
                xmlhttp.open("GET", url_bin, !0), xmlhttp.setRequestHeader("Auth-Token", this.getAuthToken(this.PAYMENT_CLIENT_APP_CODE, this.PAYMENT_CLIENT_APP_KEY));
            }
            (xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState === XMLHttpRequest.DONE)
                    try {
                        let objResponse = JSON.parse(xmlhttp.responseText);
                        200 === xmlhttp.status ? successCallback(objResponse, form) : errorCallback(objResponse);
                    } catch (e) {
                        errorCallback({ error: { type: "Server Error", help: "Server Error", description: "Server Error" } });
                    }
            }),
        ...
        this.IS_CHECKOUT ? initFunction() : _getTime(initFunction);
    }),
    (Payment.verifyTransaction = function (user_id, transaction_id, verification_type, value, successCallback, errorCallback) {
        _getTime(
            function () {
                let data = { user: { id: user_id }, transaction: { id: transaction_id }, type: verification_type, value: value, more_info: !0 },
                    xmlhttp = new XMLHttpRequest(),
                    SERVER_URL = this.getServerURL();
                xmlhttp.open("POST", SERVER_URL + "/v2/transaction/verify", !0),
                    xmlhttp.setRequestHeader("Content-Type", "application/json"),
                    xmlhttp.setRequestHeader("Auth-Token", Payment.getAuthToken(Payment.PAYMENT_CLIENT_APP_CODE, Payment.PAYMENT_CLIENT_APP_KEY)),
                    (xmlhttp.onreadystatechange = function () {
                        if (xmlhttp.readyState === XMLHttpRequest.DONE)
                            try {
                                let objResponse = JSON.parse(xmlhttp.responseText);
                                200 === xmlhttp.status ? successCallback(objResponse) : errorCallback(objResponse);
                            } catch (e) {
                                errorCallback({ error: { type: "Server Error", help: "Server Error", description: "Server Error" } });
                            }
                    }),
...
!(function (I) {
    ...
    function E(c, a, d) {
        ...
        for (g = 0; g < b; g += 3)
            for (
                f = g + 1 < b ? c[(g + 1) >>> 2] : 0,
                    n = g + 2 < b ? c[(g + 2) >>> 2] : 0,
                    n = (((c[g >>> 2] >>> (8 * (3 + (g % 4) * -1))) & 255) << 16) | (((f >>> (8 * (3 + ((g + 1) % 4) * -1))) & 255) << 8) | ((n >>> (8 * (3 + ((g + 2) % 4) * -1))) & 255),
                    f = 0;
                4 > f;
                f += 1
            )
                l += 8 * g + 6 * f <= a ? "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((n >>> (6 * (3 - f))) & 63) : d.b64Pad;
        return l;
    }
    function F(c, a) {
        var b,
                ...
                d = function (c, b, d) {
                    ...
                    if (((b = b || [0]), (q = (d = d || 0) >>> 3), "UTF8" === a))
                        for (r = 3, e = 0; e < c.length; e += 1)
                            for (
                                n = [],
                                    128 > (f = c.charCodeAt(e))
                                        ? n.push(f)
                                        : 2048 > f
                                        ? (n.push(192 | (f >>> 6)), n.push(128 | (63 & f)))
                                        : 55296 > f || 57344 <= f
                                        ? n.push(224 | (f >>> 12), 128 | ((f >>> 6) & 63), 128 | (63 & f))
                                        : ((e += 1), (f = 65536 + (((1023 & f) << 10) | (1023 & c.charCodeAt(e)))), n.push(240 | (f >>> 18), 128 | ((f >>> 12) & 63), 128 | ((f >>> 6) & 63), 128 | (63 & f))),
                                    h = 0;
                                h < n.length;
                                h += 1
                            ) {
    ...
    function A(c, a, d) {
        ...
        for (r = 64, w = 1, F = Number, t = P, x = Q, u = R, z = N, A = O, B = L, C = M, E = K, D = J, G = H, d = a[0], l = a[1], b = a[2], g = a[3], f = a[4], n = a[5], k = a[6], e = a[7], p = 0; p < r; p += 1)
            16 > p ? ((m = p * w), (h = c.length <= m ? 0 : c[m]), (m = c.length <= m + 1 ? 0 : c[m + 1]), (v[p] = new F(h, m))) : (v[p] = x(A(v[p - 2]), v[p - 7], z(v[p - 15]), v[p - 16])),
    ...
    (H = [
        ...
        window && (window.jsSHA = w),
        "function" == typeof define && define.amd
            ? define(function () {
                  return w;
              })
            : "undefined" != typeof exports
            ? ("undefined" != typeof module && module.exports && (module.exports = w), (exports = w))
            : (I.jsSHA = w);
})(this);
