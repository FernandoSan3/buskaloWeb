    ...
    */
    ...
    'emails' => [
        'auth' => [
            ...
            'password_cause_of_email' => 'Hemos recibido una solicitud para reestablecer la contraseña de tu cuenta.<br/>
                Haz un clic en el botón o en el link aquí para restablecerla.',
