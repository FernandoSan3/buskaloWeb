...
{{ html()->form('POST', route('admin.cities.store'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted"> @lang('labels.backend.cities.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="form-group row">
                ...
                <label class="col-md-2 form-control-label">Select Province </label>   
