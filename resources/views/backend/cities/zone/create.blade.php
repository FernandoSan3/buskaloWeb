...
@section('content')
{{ html()->form('POST', route('admin.cities.store_polygon'))->class('form-horizontal')->id('question-form')->open() }}

<input type="hidden" name="city_id" class="" value="{{ $city_id }}">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">create polygon
                        </small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">                            
                              <select name="area_type" class="form-control">
                                  <option value="low_resources_area_2">Low Resources Area 2</option>
                                  <option value="avg_resources_area">Average Resources Area</option>
                                  <option value="high_resources_area_1">Most Expensive Area 1</option>
                                  <option value="high_resources_area_2">Most Expensive Area 2</option>
                              </select>
                        </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                              ...
                              <input type="text" required="" name="title" class="form-control" value="" placeholder="Enter Title" >
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6" >
                            ...
                            <input type="address" required="" id="geofencings-address" name="address" class="form-control" value="">
                        </div><!--col-->
                    </div><!--form-group-->
        ...
        google.maps.event.addListener(autocomplete, 'place_changed', function () {
            ...
            google.maps.event.addListener(drawingManager, 'polygoncomplete', function(event) {
                    ...
                    u++;
                        ...
                        console.log('here ayus');
                        console.log(array1);
                        var valq = JSON.stringify(array1);
                         console.log('here ayus valq');
                        console.log(valq);
                        //console.log(valq);
                        $('#cordi').val(valq);
                        ay_geo_cordinate.push(valq);
                        console.log('here ay');
                        console.log(ay_geo_cordinate);
