...
@section('content')
{{ html()->form('POST', route('admin.cities.update_zone'))->class('form-horizontal')->id('question-form')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select name="area_type" class="form-control">
                                ...
                                <option <?php if($geoFenc->area_type == 'avg_resources_area' ) { ?> selected <?php } ?> value="avg_resources_area">Average</option>
