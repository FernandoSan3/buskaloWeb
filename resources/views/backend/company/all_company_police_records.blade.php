        ...
        <div class="row">
            ...
            <div class="col-sm-7 pull-right">
                ...
                <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                    ...
                    <a href="{{ route('admin.company.add_company_police_records',$user_id) }}" class="btn btn-success ml-1" data-toggle="tooltip" title="@lang('labels.general.create_new')"><i class="fas fa-plus-circle"></i></a>
                </div>
            </div><!--col-->
        </div><!--row-->
