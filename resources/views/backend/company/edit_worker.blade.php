...
{{ html()->form('POST', route('admin.company.update_worker'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <!-- @lang('labels.backend.questions.create') --> Update Worker</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
