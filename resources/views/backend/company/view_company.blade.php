...
@section('title', __('labels.backend.company.management') . ' | ' . __('labels.backend.company.view'))
        ...
        <div class="row">
            <div class="col-sm-5">
               <h4 class="card-title mb-0">
                   ...
                   {{-- @lang('labels.backend.questions.view')--}}
                   @lang('labels.backend.company.view')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="overview" role="tabpanel" aria-expanded="true">
                        @include('backend.company.show.tabs.company_overview')
                    </div><!--tab-->
                </div><!--tab-content-->
            </div><!--col-->
        </div><!--row-->
