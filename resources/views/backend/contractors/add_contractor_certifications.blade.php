...
{{ html()->form('POST', route('admin.contractors.store_contractor_certificate'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <!-- @lang('labels.backend.questions.create') --> Add Certificates</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="form-group row">
                        <label class="col-md-2 form-control-label"> Certification Type:</label>
                        <div id="">           
                    ...
                    <div class="form-group row">
                        ...
                        <div class='file_upload' id='f1'>           
                            ...
                            <input name='certification_courses[]' type='file'/>                           
                        </div>
