            ...
            <div class="col-sm-7 pull-right">
               {{--  @include('backend.contractors.includes.header-buttons') --}}
                ...
                <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                    ...
                    <a href="{{ route('admin.contractors.add_contractor_certificate',$user_id) }}" class="btn btn-success ml-1" data-toggle="tooltip" title="@lang('labels.general.create_new')"><i class="fas fa-plus-circle"></i></a>
                </div>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                       <?php  if(isset($cetifications) && count($cetifications)>0) {?>
