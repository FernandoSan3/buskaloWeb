...
@section('content')
{{ html()->form('POST', route('admin.contractors.update'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                       ...
                       {{--  @lang('labels.backend.questions.update') --}}Update</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
