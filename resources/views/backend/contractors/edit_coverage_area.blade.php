...
{{ html()->form('POST', route('admin.contractors.update_coverage_area'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <!-- @lang('labels.backend.questions.create') --> Edit Coverage Area</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="form-group row">
                        ...
                        <div >
                             <input type="radio" <?php if($whole_country == 'Yes'){?> checked <?php } ?> id="inWholeCountryTrue1" name="whole_country" value="1" > true

                            <input type="radio" <?php if($whole_country == 'No'){?> checked <?php } ?>  id="inWholeCountryFalse1" name="whole_country" value="0" > fasle
                        </div>
                    </div>
