...
@section('content')
{{ html()->form('POST', route('admin.contractors.update_ratings_reviews'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
...
<div class="card">
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.general.actions1.edit_ratings_reviews')</small>
                </h4>
            </div>
            <!--col-->
        </div>
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col">
            <!-- route('admin.contractors.ratings_reviews',$user->id) -->
                {{ form_cancel(route('admin.contractors.ratings_reviews', $ratings_reviews->user_id), __('buttons.general.cancel')) }}
            </div>
            <!--col-->
