                ...
                <div class="col">
                    <div class="form-group row">
                        {{-- html()->label(__('validation.attributes.backend.access.roles.name'))
                            ...
                            ->for('name') --}}
                         <label class="col-md-2 form-control-label">Usuario o Profesional</label>   

                        <div class="col-md-10">
                            <select name="question_type" class="form-control" required>
                                <option value=""> Selecciona</option>
                                <option value="1" @if(isset($faqedit->question_type)&& $faqedit->question_type=='1') selected @endif>Usuario</option>
                                <option value="2"  @if(isset($faqedit->question_type)&& $faqedit->question_type=='2') selected @endif>Profesional</option>
                            </select>
                        </div><!--col-->
                    </div><!--form-group-->
                    <div class="form-group row">
