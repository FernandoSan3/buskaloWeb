...
@section('title', __('News management') . ' | ' . __('create News'))
...
<div class="card">
        ...
        <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted"> @lang('create news')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
  ...
  {{ html()->form('POST', route('admin.news.updatenews'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
     ...
     <div class="form-group row">
       ...
       <div class="col-md-10">
         {{ html()->textarea('description')
                ->class('form-control')
                ->value(isset($news->description)?$news->description:'')
