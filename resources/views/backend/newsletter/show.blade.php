...
@section('title', __('labels.backend.contactus.management') . ' | ' . __('labels.backend.contactus.view'))
        ...
        <div class="row">
            <div class="col-sm-5">
               <h4 class="card-title mb-0">
                    ...
                    @lang('labels.backend.contactus.view')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="overview" role="tabpanel" aria-expanded="true">
                        @include('backend.contactus.show.tabs.overview')
                    </div><!--tab-->
                </div><!--tab-content-->
            </div><!--col-->
        </div><!--row-->
