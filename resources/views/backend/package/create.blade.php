...
@section('content')
{{ html()->form('POST', route('admin.package.store'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="price" id="price" placeholder="Price" maxlength="191" required="" autofocus="" step="any">
                            <!-- {{ html()->Number('price')
                                ->class('form-control')
