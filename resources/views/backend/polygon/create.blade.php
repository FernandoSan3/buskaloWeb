...
@section('title', __('labels.backend.polygon.management') . ' | ' . __('labels.backend.polygon.create'))

@section('content')
{{ html()->form('POST', route('admin.polygon.store'))->class('form-horizontal')->id('question-form')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        @lang('labels.backend.polygon.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                              <select name="area_type" class="form-control">
                                  <option value="low_resources_area">Low Resources Area</option>
                                  <option value="average">Average</option>
                                  <option value="most_expensive_area">Most Expensive Area</option>
                              </select>
                        </div><!--col-->
                    </div>
