...
@section('title', __('labels.backend.polygon.management') . ' | ' . __('labels.backend.zone.create'))

@section('content')
{{ html()->form('POST', route('admin.polygon.update'))->class('form-horizontal')->id('question-form')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                         @lang('labels.backend.polygon.management')
                        <small class="text-muted">
                        @lang('labels.backend.polygon.update')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
