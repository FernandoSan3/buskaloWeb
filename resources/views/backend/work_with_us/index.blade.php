...
{{--@section('title', __('labels.backend.work_with_us.management'))--}}
{{--@section('title', app_name() . ' | '. __('labels.backend.work_with_us.management'))--}}


@section('title', __('labels.backend.work_with_us.management') . ' | ' . __('labels.backend.work_with_us.create'))
...
<div class="card">
        ...
        <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                         @lang('labels.backend.work_with_us.management')
                        <small class="text-muted"> @lang('labels.backend.work_with_us.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
  ...
  {{ html()->form('POST', route('admin.work_with_us.updateWorkWithUs'))->attribute('enctype', 'multipart/form-data')->class('form-horizontal')->open() }}
...
<div class="tab-content mytab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="Constractor" role="tabpanel" aria-labelledby="Constractor-tab">
     ...
     <div class="form-group row">
       ...
       <div class="col-md-10">
         {{ html()->textarea('description_cons')
              ->class('form-control')
              ->value($work_with_us->description_cons)
    ...
    <div class="card-footer">
      <div class="row">
        <div class="col">
            {{ form_cancel(route('admin.work_with_us.index'), __('buttons.general.cancel')) }}
        </div><!--col-->
    ...
    <div class="form-group row">
       ...
       <div class="col-md-10">
         {{ html()->textarea('description_comp')
              ->class('form-control')
              ->value($work_with_us->description_comp)
              ->placeholder('Description')
              ->required()
              ->autofocus() }}
       </div><!--col-->
