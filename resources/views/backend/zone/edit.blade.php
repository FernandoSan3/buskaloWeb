...
@section('content')
{{ html()->form('POST', route('admin.zone.update'))->class('form-horizontal')->id('question-form')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        @lang('labels.backend.zone.update')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                              <select name="area_type" class="form-control">
                                  <option <?php if($geoFenc->area_type == 'low_resources_area' ) { ?> selected <?php } ?> value="low_resources_area">Low Resources Area</option>
                                  <option <?php if($geoFenc->area_type == 'average' ) { ?> selected <?php } ?> value="average">Average</option>
                                  <option <?php if($geoFenc->area_type == 'most_expensive_area' ) { ?> selected <?php } ?> value="most_expensive_area">Most Expensive Area</option>
                              </select>
                        </div><!--col-->
                    </div>
...
<script type="text/javascript">
    ...
    //ay_geo_cordinate_new_ay = <?php echo $old_geofenc; ?>;
    //var testay = ay_geo_cordinate_new_ay.split(']]');

    // console.log('ay_geo_cordinate_new_ay');
    // console.log(ay_geo_cordinate_new_ay);
    ...
    // console.log('uyuyu');
    // console.log(ay_geo_cordinate_new);
    ...
    // });
     ...
     // delete ay_geo_cordinate_new[1];
      //console.log(ay_geo_cordinate_new);
     // $('.geo-cordinate').val(ay_geo_cordinate_new);
