                        ...
                        <div class="tab-pane fade show <?php if($count == 1){echo 'active show';} ?>" id="tab{{$count}}" role="tabpanel">
                          <div class="ser_name text-left">
                            ...
                            <div class="tab-btn text-center">
                              <a href="{{url('company_profile/rating_review?serviceId='.$jobs['service_request_id'].'&prouserId='.$jobs['user_id'])}}"><button class="btn btn-tab w-85 mb-4">@lang('labels.frontend.constructor.profile.request_rating_and_comments')</button></a>

                              <!--  <a href="{{url('company_profile/payment/request?serviceId='.$jobs['service_request_id'].'&prouserId='.$jobs['user_id'].'&requestid='.$jobs['asignid'])}}"></a> -->
                              <button class="btn btn-tab outline-btn-tab w-85"  data-toggle="modal" data-target="#exampleModal_{{$jobs['asignid']}}"> <i class="fa fa-credit-card text-secondary"></i> @lang('labels.frontend.constructor.profile.receive_payment_by_credit_card')</button>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                       ...
                                       <form method="post" action="{{url('company_profile/payment/request/web')}}">
                                        {{csrf_field()}}
