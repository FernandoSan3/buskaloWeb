                        ...
                        <div class="tab-pane fade show <?php if($count == 1){echo 'active show';} ?>" id="tab{{$count}}" role="tabpanel">
                          <div class="text-center">
                            <div class="star-div">
                              ...
                              <div class="tab-btn">
                                 <a href="{{route('frontend.contractor.ignore_opportunity',Crypt::encrypt($opprtunity['service_request_id']))}}"><button class="btn btn-tab outline-btn-tab">@lang('labels.frontend.constructor.profile.ignore')</button></a>
                                <span style="display: none;" class="checktrue"> <a href="{{route('frontend.contractor.buy_opportunity',Crypt::encrypt($opprtunity['id']))}}"><button class="btn btn-tab">@lang('labels.frontend.constructor.profile.buy')</button></a></span>
                                <span>
