        ...
        <div class="row">
          <div class="col-md-12 border-right">
            <div class="ser_name">
              ...
              <h4 class="heading">Opportunity Details</h4> <span style="margin-left: 93%;"><a href="{{route('frontend.contractor.opportunities')}}">Back </a></span>
              ...
              <h4><a href="{{route('frontend.contractor.buy_opportunity',Crypt::encrypt($data['id']))}}"><i class="link-dt">BUY</i></a></h4>
