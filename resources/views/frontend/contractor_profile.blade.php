                  ...
                  <div class="profile-head">
                    ...
                    <div class="col-md-12 mt-5">
                      ...
                      <div class="pro-info">
                        ...
                        <ul class="info-list edit-pro-input">
                          <li>
                            <h6>@lang('labels.frontend.constructor.redirect_constructor.insert_a_photo_or_company_logo')</h6>
                          </li>
                        </ul>
                    ...
                    <div class="pro-info">
                      ...
                      <ul class="info-list edit-pro-input">
                        ...
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.id_number')*</h6>
                        ...
                        <li>
                          <h6>{{--Titulo de perfil* --}}@lang('labels.frontend.constructor.redirect_constructor.profession')*</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.direction')*</h6>
                        ...
                        <li>
                          <h6>@lang('Fecha de nacimiento')*</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.company.redirect_company.web_address')</h6>
                          ...
                          <!--  <input type="text" placeholder="@lang('labels.frontend.company.redirect_company.web_address')" id="webDirection" name="website_address" class="">
                                -->
                          <div class="webDirection-msg" style="text-align: center;"></div>
                        </li>

                        <li>
                          <h6>@lang('labels.frontend.company.profile.username')*</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.company.profile.office_address')</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.company.profile.mobile_phone_number')*</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.company.profile.landline_number')</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.company.profile.office_number')</h6>
                    ...
                    <div class="pro-info">
                      ...
                      <ul class="info-list edit-pro-input">
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.facebook')</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.instagram')</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.linkedin')</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.twitter')</h6>
                        ...
                        <li>
                          <h6>@lang('labels.frontend.constructor.redirect_constructor.other_url')</h6>
                    ...
                    <div class="pro-info">
                      ...
                      <div class="desc-content">
                        <ul class="info-list">
                          <li>
                            <h6>@lang('labels.frontend.constructor.redirect_constructor.brief_description')*</h6>
                          </li>
                        </ul>
                        {{ html()->textarea('profile_description',isset($getUser->profile_description)?$getUser->profile_description:'')
                                ->placeholder(__('Breve descripción de su negocio'))
                                ->required() }}
                            ...
                            <select name="services[]" id="multi-select-services" multiple="multiple" required oninvalid="this.setCustomValidity('Llene los campos obligatorios');" onchange="try{setCustomValidity('')}catch(e){};">
                              ...
                              if (!empty($combineddata)) {
                                foreach ($combineddata as $key_com => $val_com) { ?>
                                  ...
                                  <?php $i = 1;
                                  foreach ($val_com['subservices'] as $sdata) {
                                  ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 pro-info">
                        ...
                        <div class='file_upload' id='f1'>
                          ...
                          <input name='police_records[]' id="files" type="file" style="text-overflow: ellipsis;  overflow: hidden;" />
                        </div>
                      ...
                      <div class="col-md-6 pro-info">
                        <div class="pro-heading">
                          <h3>
                            ...
                            @lang('labels.frontend.constructor.redirect_constructor.the_whole_country'):
                          </h3>
                        </div>
                        <!-- <div class="meta-list">
    ...
    $(document).ready(function() {
      ...
      $('#identityNo').on('input', function() {
        ...
        if (identityNo.length == 0) {
          $('.identity-no-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.identity_is_not_required ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
        } else if (!validName.test(identityNo)) {
          $('.identity-no-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.only_numbers_are_allowed ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
      ...
      $('#profileTitle').on('input', function() {
        ...
        if (!validName.test(profileTitle)) {
          $('.profile-title-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.only_characters ')');
      ...
      $('#address').on('input', function() {
        ...
        if (!validName.test(address)) {
          $('.address-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.address_must_have_alphanumeric ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
          $('.address-msg').empty();
          $(this).addClass('extravalid-input').removeClass('extrainvalid-input');
      ...
      $('#landline_number').on('input', function() {
        ...
        if (!validName.test(landline)) {
          $('.landline-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.company.redirect_company.landline_must_have_numeric ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
        } else {
          $('.landline-msg').empty();
          $(this).addClass('valid-input').removeClass('invalid-input');
      ...
      $('#office_number').on('input', function() {
        ...
        if (!validName.test(mobile)) {
          $('.office-number-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.company.redirect_company.mobile_must_have_numeric ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
        } else {
      ...
      $('#profile_title').on('input', function() {
        ...
        if (profile_title.length == 0) {
          $('.profile_title-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.company.redirect_company.profile_title_is_required ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
        } else if (profile_title.length <= 3) {
          $('.profile_title-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.company.redirect_company.atleast_4_character_required ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
        } else if (!validName.test(profile_title)) {
          $('.profile_title-msg').addClass('invalid-msg').text('@lang('
            labels.frontend.company.redirect_company.only_characters_allowed ')');
          $(this).addClass('invalid-input').removeClass('valid-input');
        } else {
      ...
      $('#landlineNumber').on('input', function() {
        ...
        if (!validName.test(landlineNumber)) {
          $('.landline-number-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.landline_number ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
      ...
      $('#facebookUrl').on('input', function() {
        ...
        if (!validName.test(facebookUrl)) {
          $('.facebook-url-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.invalid_url ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
      ...
      $('#instagramUrl').on('input', function() {
        ...
        if (!validName.test(instagramUrl)) {
          $('.instagram-url-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.invalid_url ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
      ...
      $('#linkedinUrl').on('input', function() {
        ...
        if (!validName.test(linkedinUrl)) {
          $('.linkedin-url-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.invalid_url ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
      ...
      $('#twitterUrl').on('input', function() {
        ...
        if (!validName.test(twitterUrl)) {
          $('.twitter-url-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.invalid_url ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
      ...
      $('#otherUrl').on('input', function() {
        ...
        if (!validName.test(otherUrl)) {
          $('.other-url-msg').addClass('extrainvalid-msg').text('@lang('
            labels.frontend.constructor.redirect_constructor.invalid_url ')');
          $(this).addClass('extrainvalid-input').removeClass('extravalid-input');
        } else {
          $('.other-url-msg').empty();
