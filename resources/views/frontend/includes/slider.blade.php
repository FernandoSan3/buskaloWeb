<section class="slider-sec">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" style="background-image: url({{ url('img/frontend/slide1.jpg') }})">
    ...
    <div class="carousel-caption">
      <h3><span>“</span>@lang('labels.frontend.home_page.we_make_your_life') <span class="orange">@lang('labels.frontend.home_page.online')</span> <b>@lang('labels.frontend.home_page.easier')</b><span>”</span></h3>
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
          ...
          <ul>
            <li>@lang('labels.frontend.home_page.answer_and_questions')</li>
            <li>@lang('labels.frontend.home_page.receive_information')</li>
            <li>@lang('labels.frontend.home_page.best_one')</li>
          </ul>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="col-lg-5 col-md-6 col-sm-12">
            <div class="form-group loc-input">
              ...
              <button type="submit" class="btn book-btn"><img src="{{ url('img/frontend/search.png') }}"></button>
            </div>
          </div>
        </div>
