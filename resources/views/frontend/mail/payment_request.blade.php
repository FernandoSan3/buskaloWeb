  ...
  <div style="display: block; width: 100%; margin: 0; background: #fff;">
    <div style="background: #f5f5f5; display: inline-block; width: 100%; padding: 10px 0; text-align: center;">
      ...
      <div style="display: block; width: 70%; margin: 50px auto;">
         ...
         <h4 style="font-size: 16px; color: #808080; font-weight: 600; margin: 0 0 20px;">
            ...
            {{ isset($data['message'])?$data['message']:'' }}
                <table width="200px">
                    <tr>
                        <th>Subtotal: $</th>
                        <th>{{isset($data['subtotal'])?$data['subtotal']:''}}</th>
                    </tr>
                    <tr>
                        <th>IVA: $</th>
                        <th>{{isset($data['iva'])?$data['iva']:''}}</th>
                    </tr>
                    <tr>
                        <th>Total: $</th>
                        <th>{{isset($data['total'])?$data['total']:''}}</th>
                    </tr>
                </table>
            
             <p>Haz clic en el botón o en el link <a href="{{$data['actionurl']}}">aquí </a> para realizar tu pago.</p>
       ...
       <!--   {{ isset($data['messagesub'])?$data['messagesub']:'' }} -->
