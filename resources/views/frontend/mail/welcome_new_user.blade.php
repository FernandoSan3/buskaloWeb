      ...
      <div style="display: block; width: 70%; margin: 50px auto;">
        ...
        <div style="display: inline-block; width: 100%; margin-top: 30px;">
          <h4 style="font-size: 16px; color: #808080; font-weight: 600; margin: 0 0 20px;">
            {{-- Intro Lines --}}
               <p>{{ $demo->message }}</p> <h3>{{ $demo->password }}</h3>
          </h4>
        ...
        Si el botón no funciona copie y pegue el link es su URL,si el problema persiste por favor comuníquese con nosotros a
                   <a style="color: #e74621; text-decoration: none;" href="#">support@buskalo.com</a>
