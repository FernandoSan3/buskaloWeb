...
<script>  
  var paymentezCheckout = new PaymentezCheckout.modal({
      ...
      onResponse: function(response) {
        ...
        {
             var packid=<?php echo $package->id;?>;
            $.ajax({
                 headers: {
                ...
                type:"post",
                data: {'response':response,'packageid':packid},
  ...
  btnOpenCheckout.addEventListener('click', function(){
    ...
    paymentezCheckout.open({
      ...
      order_amount: <?php echo $package->price;?>,
      order_vat:<?php echo $vatamount;?>,
      ...
      order_taxable_amount: <?php echo $taxamount;?>, // optional: Only available for Ecuador. The taxable amount, if it is zero, it is calculated on the total. Format: Decimal with two fraction digits.
