        ...
        <div class="tab-pane active request-tabs" id="trabajos">
            <div class="side-heading">
                <div class="row">
                  <div class="col-md-4">
                    <div class="head-side">
                      <h3>@lang('labels.frontend.user.account.all_pending_requests')</h3>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="job-btns">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" data-s_type ='0' id="search_text" onkeyup="getSearchRequest(this.value, 0)" name="search_text"  placeholder="@lang('labels.frontend.user.account.search')">
                    </div>
                  </div>
                </div>
              </div>
