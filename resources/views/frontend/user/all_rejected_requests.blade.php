        ...
        <div class="tab-pane active request-tabs" id="trabajos">
            <div class="side-heading">
                <div class="row">
                  <div class="col-md-4">
                    <div class="head-side">
                      <h3>@lang('labels.frontend.user.account.all_rejected_requests')</h3>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="job-btns">
                   {{--   <a class="link-dt" href="{{route('frontend.user.all-requests')}}"><button type="button" class="btn btn-danger">@lang('labels.frontend.user.account.all')</button></a>
                  ...
                  <div class="col-md-4">
                    <div class="search-side">
                      <input type="text" data-s_type ='3' id="search_text" onkeyup="getSearchRequest(this.value, 3)" name="search_text"  placeholder="@lang('labels.frontend.user.account.search')">
