        ...
        <div class="tab-pane active request-tabs" id="trabajos">
            <div class="side-heading">
                <div class="row">
                  <div class="col-md-4">
                    <div class="head-side">
                      <h3>@lang('labels.frontend.user.account.all_requests')</h3>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="job-btns">
                  ...
                  <div class="col-md-4">
                    <div class="search-side">
                      <input type="text" data-s_type ='all' id="search_text" onkeyup="getSearchRequest(this.value, 'all')" name="search_text"  placeholder="@lang('labels.frontend.user.account.search">
                ...
                <div class="col-md-6">
                  <div class="media opp-list p-3">
                    ...
                    <div class="media-body">
                      ...
                      <h4>{{$dataaa->service_name}}{{-- Requerimiento de Instalacion --}}</h4>
                      <span>{{ \Carbon\Carbon::parse($dataaa->created_at)->format('d M Y H:i:s A')}} 
