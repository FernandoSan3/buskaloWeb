...
<!--   <div class="top-header-profile">
  ...
  <div id="wrapper" class="toggled left-sidebar">
      ...
      <div class="chat-container">
        <div class="messaging content01">
          <div class="top-profile-sec pro-wrapper py-4">
            ...
            <span>@lang('labels.frontend.project.chat')</span><!--
            ...
            <div class="inbox_people">
              <div class="headind_srch">
                <div class="recent_heading">
                  <h4>@lang('labels.frontend.project.chat')</h4>
                </div>
              </div>
              <div class="inbox_chat content01">
                <div class="chat_list active_chat">
                  ...
                  @endforeach
                  @else
                  <p>@lang('labels.frontend.project.no_users_found') <a href="{{ url('register') }}">@lang('labels.frontend.project.register_page')</a></p>
                  @endif
                </div>
              </div>
            </div>
   ...
   @include('frontend.user.chat-box')
