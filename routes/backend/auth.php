...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::get('user/show_service_request/{id}', [UserController::class, 'showServiceRequest'])->name('user.show_service_request');

        //Route::get('company/service_request_company/{id}', [CompanyController::class, 'serviceRequests'])->name('company.serviceRequests');

     Route::get('user/all_requests_by_status/{status}/{user_id}', [UserController::class, 'allRequestsByStatus'])->name('user.all_requests_by_status');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::get('edit_user', [UserController::class, 'editUserDetails'])->name('user.edit_user');

           Route::patch('update_user', [UserController::class, 'updateUserDetails'])->name('user.update_user');

           Route::get('service_request', [UserController::class, 'userServiceRequest'])->name('user.service_request');
