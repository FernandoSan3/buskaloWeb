...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::get('register/otpVerify/{userid}', [RegisterController::class, 'otpVerify'])->name('register.otpVerify');
        Route::post('register/verifyOtp', [RegisterController::class, 'verifyOtp'])->name('register.verifyOtp');
        ...
        Route::get('password/resetapp/{apptoken}',  [ResetPasswordController::class, 'showResetFormApp']);
        Route::post('password/resetapp', [ResetPasswordController::class, 'resetApp'])->name('password.resetapp');
        Route::get('password', [ResetPasswordController::class, 'passwordGet'])->name('password.get');
        Route::post('password', [ResetPasswordController::class, 'passwordPost'])->name('password.set.post');
    });
});
