...
<section class="works-sec serv-online mx">
    <div class="container">
        <div class="heading">
            <h2><b><?php echo app('translator')->get('labels.frontend.about.about_us'); ?></b></h2>
            ...
            <div class="col-lg-12">
              ...
              if(!empty($about_us)) {
                foreach ($about_us as  $value) {
                  ...
                  <p><?php echo app('translator')->get('labels.frontend.about.about_us_not_found'); ?></p>
              <?php }?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Buskalo_WEB/Buskalo_WEB/resources/views/frontend/about_us.blade.php ENDPATH**/ ?>