          ...
          <?php echo e(html()->form('POST', route('frontend.auth.register.post'))->class('form-signin form-register')->id('register_form')->open()); ?>
            ...
            <?php endif; ?>
              ...
              <div class="input-group1">
                <label class="col-sm-12 col-form-label"><?php echo app('translator')->get('Recaptcha'); ?>:</label>
              </div>
              <div class="input-group1">
...
<?php echo $__env->make('frontend.layouts.auth_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Buskalo_WEB/resources/views/frontend/auth/register.blade.php ENDPATH**/ ?>