      ...
      <div class="col-lg-2 col-md-12 col-sm-12">
        <div class="foot-detail">
          <a href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(url('img/frontend/logo-f.png')); ?>">
        </a>
...
<div class="col-lg-2 col-md-6 col-sm-6">
    <div class="useful-link">
      <h4 class="foot-head"><?php echo app('translator')->get('labels.frontend.company.profile.customers'); ?></h4>
      <ul>
        <li><a href="<?php echo e(url('redirect_register')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.check_in'); ?></a></li>
        <li><a href="<?php echo e(url('how-does-it-work/user')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.how_does_it_work'); ?></a>
        </li>
        <li><a href="<?php echo e(url('faq/user')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.help_users'); ?></a>
        </li>
    </ul>
</div>
</div>
<div class="col-lg-2 col-md-6 col-sm-6">
    <div class="useful-link">
      <h4 class="foot-head"><?php echo app('translator')->get('labels.frontend.company.profile.professional'); ?></h4>
      <ul>
        <li><a href="<?php echo e(url('profesional/register')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.join_register'); ?></a></li>
        <li><a href="<?php echo e(url('how-does-it-work/pro')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.how_does_it_work'); ?></a>
        </li>
        <li><a href="<?php echo e(url('faq/pro')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.help_profesional'); ?></a>
        </li>
...
<div class="col-lg-3 col-md-6 col-sm-6">
    <div class="useful-link">
      ...
      <ul>
        <li><a href="<?php echo e(url('about-us')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.about_us'); ?></a></li>
        <li><a href="<?php echo e(url('work-with-us')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.work_with_us'); ?></a></li>
        <li><a href="<?php echo e(url('contact')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.contact_us'); ?></a></li>
        <li><a href="<?php echo e(url('characteristics-conditions')); ?>"><?php echo app('translator')->get('labels.frontend.company.profile.terms_and_conditions'); ?></a></li>
           <!--  <li><a href="<?php echo e(url('faq')); ?>"><?php echo app('translator')->get('Preguntas más frecuentes
           '); ?></a>      </li> -->
       </ul>
   </div>
</div>
...
<div class="col-lg-3 col-md-6 col-sm-6">
    <div class="useful-link">
      <h4 class="foot-head"><?php echo app('translator')->get('labels.frontend.company.profile.follow_us_on'); ?></h4>
      <div class="social-link">
        <a href="<?php echo e(isset($socilaLink->facebook)?$socilaLink->facebook:'#'); ?>"><i class="fa fa-facebook"></i></a>
        <a href="<?php echo e(isset($socilaLink->instagram)?$socilaLink->instagram:'#'); ?>"><i class="fa fa-instagram"></i></a>
        <!-- <a href="<?php echo e(isset($socilaLink->twitter)?$socilaLink->twitter:'#'); ?>"><i class="fa fa-twitter"></i></a> -->
        <a href="<?php echo e(isset($socilaLink->youtube)?$socilaLink->youtube:'#'); ?>"><i class="fa fa-youtube"></i></a>
    </div>

    <div class="download-btns">
        <a class="app-btn" href="https://apps.apple.com/us/app/búskalo/id1580560610">
          <div class="app-icon">
            <img src="<?php echo e(url('img/frontend/apple.png')); ?>">
        </div>
        <div class="app-txt">
            <p><?php echo app('translator')->get('labels.frontend.company.profile.download_on_the'); ?></p>
            <h5 class="appsotre-font"><?php echo app('translator')->get('labels.frontend.company.profile.app_store'); ?></h5>
        </div>
    </a>
    <a class="app-btn" href="https://play.google.com/store/apps/details?id=com.wdp.Buskalo">
      <div class="app-icon">
        <img src="<?php echo e(url('img/frontend/play-store.png')); ?>">
    </div>
    <div class="app-txt">
        <p><?php echo app('translator')->get('labels.frontend.company.profile.get_it_on'); ?></p>
        <h5><?php echo app('translator')->get('labels.frontend.company.profile.google_play'); ?></h5>
    </div>
</a>
</div>
...
<?php echo e(script('js/popper.min.js')); ?>

<?php echo e(script('js/bootstrap.min.js')); ?>

<!-- <?php echo e(script('js/bootstrap.bunde.js')); ?> -->


<?php echo e(script('js/jquery.dataTables.min.js')); ?>

<?php echo e(script('js/dataTables.rowReorder.min.js')); ?>

<?php echo e(script('js/dataTables.responsive.min.js')); ?>

<?php echo e(script('select2/dist/js/select2.min.js')); ?>

<?php echo e(script('js/bootstrap-datetimepicker.js')); ?>

<?php echo e(script('js/owl.carousel.min.js')); ?>
...
<script type="text/javascript">
  ...
  function showLoader(){
    $('body').append('<div class="site-loader"> <img src="<?php echo e(url('img/logo/loading.gif')); ?>"></div>');
    return '';
}
function hideLoader(){  
    $('.site-loader').remove();
...
<?php if(isset($logged_in_user->user_group_id) && $logged_in_user->user_group_id==3): ?>
...
<script>  
  ...
  boundary:{
    ...
    $('#insertimageModal').modal('show');
       ...
       $.ajax({
        url: "<?php echo URL::to('insert_contractor_profile'); ?>",
        type:'POST',
        data: {"_token": "<?php echo e(csrf_token()); ?>","image": response,"userid": userId },
        dataType: "json",
...
<?php elseif(isset($logged_in_user->user_group_id) && $logged_in_user->user_group_id==4): ?>
...
<script>  
  ...
  boundary:{
    ...
    $('#UserinsertimageModal').modal('show');
       ...
       $.ajax({
        url: "<?php echo URL::to('insert_user_profile'); ?>",
        type:'POST',
        data: {"_token": "<?php echo e(csrf_token()); ?>","image": response,"userid": userId },
        dataType: "json",
        success:function(data)
...
$('#profileTitle').on('input', function () 
{
 var profileTitle = $(this).val();
  ...
  $('#mobileNumber').on('input', function () 
  {
   ...
   $.ajax({
    url: "<?php echo URL::to('check_mobile_availability'); ?>",
...
<?php echo e(script('js/pusher.min.js')); ?>


<?php if(isset($logged_in_user->user_group_id) && $logged_in_user->user_group_id==3): ?>

<?php echo e(script('js/chat-contractor.js')); ?>
...
<?php echo e(script('js/chat-user.js')); ?>

<?php endif; ?> 

<?php echo e(style('css/bootstrap-multiselect.css')); ?>

<?php echo e(script('js/bootstrap-multiselect.js')); ?>
...
<script type="text/javascript">
    function fectchDynamicData(e)
    {
     ...
     var CSRF_TOKEN = '<?php echo csrf_token() ?>';
         ...
         // Fetch data
         $.ajax({
            url: '<?php echo URL::to("autoCompleteSearch"); ?>',  
            type: 'post',
            dataType: "json",
            data: {
             _token: CSRF_TOKEN,
...
function getNextQuestionsByOptionIdRelated(firstOptionID)
{
    ...
    var currentdata = sessionStorage.getItem('currentdata');
      ...
      //alert('firstOptionID:-> '+firstOptionID);
          ...
          $.ajax({
            type: "GET",  
            url: '<?php echo URL::to("ajax_get_next_questions_option"); ?>',  
  ...
  function getNextQuestionsByOptionId1(firstOptionID)
  {
    ...
    if(currentdata=='')
    {
      ...
      //alert('firstOptionID:-> '+firstOptionID);
          ...
          $.ajax({
            type: "GET",  
            url: '<?php echo URL::to("ajax_get_next_questions"); ?>',  
                ...
                if(data.success == true) 
                {
                    ...
                    if(data.nextdata==0)
                    {
                        ...
                        if(textformdata=='')
                        {
                            $('.form-btn').show();
                            $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                            $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address1" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                            return true; exit();
                        }
                        if(textformdata==0)
                        {
                            $('.form-btn').show();
                            $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                            $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address2" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                        }
                        ...
                        if(textformdata==undefined)
                        {
                            $('.form-btn').show();
                            $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                            $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address3" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                            return true; exit();
                        }
                        if(textformdata!='')
                        {
                            if(counternext1==0)
                            {
                                $('.form-btn').show();
                                $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                                $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address4" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                                counternext1++;
                                return true; exit();
...
function getNextQuestionsByOptionIdCheck(firstOptionID,checkmulti)
{
    ...
    var currentdata = sessionStorage.getItem('currentdata');
          ...
          $.ajax({
            type: "GET",  
            url: '<?php echo URL::to("ajax_get_next_questions_multipal"); ?>',  
            data:'categoryId='+categoryId+'&serviceId='+serviceId+'&subserviceId='+subserviceId+'&childsubserviceId='+childsubserviceId+'&firstQuestID='+firstQuestID+'&firstOptionID='+firstOptionID+'&questiontype='+questiontype+'&nextquestion='+nextquestion+'&predata='+currentdata,
            dataType: "json", 
            success: function(data) 
            {
            ...
            success: function(data) 
            {
                if(data.success == true) 
                {
                    ...
                    if(data.nextdata==0)
                    {
                        ...
                        { $('.form-btn').show();
                            $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                            $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address5" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                        }

                        if(textformdata==undefined)
                        { $('.form-btn').show();
                            $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                            $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address6" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                        }
                        if(textformdata!='')
                        {
                            if(counternext==0)
                            { 
                                ...
                                $('.form-btn').show();
                                $('#multi-step-application').append('<li class="nav-item"><a class="inactiveLink nav-link" data-toggle="tab" id="tab'+step_new+'" data-title ="address-title" data-step ="'+step_new+'" ></a></li>');
                                $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address7" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
                                counternext++;
                                return true; exit();
  ...
  function mergeNextQuestionArray()
  {
      ...
      var step_new = ref_this.data("step") + 1;
        ...
        if(nextquestionId==0)
        {
         ...
         {   
             // alert("blank question array");
              ...
              $('#multi-step-dataHere').append('<div class="tab-pane addressTab"  id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> ¡<?php echo app('translator')->get("labels.frontend.home_page.perfect"); ?>!</h2><p><?php echo app('translator')->get("labels.frontend.home_page.finalize"); ?></p></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png')?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.address_where"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="address8" id="address" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="addressError"></p></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)"  ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn pre-btn1" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
              return true; exit();
          }
          ...
          $('#sideQuestioName'+step_new).replaceWith('<li><h6><?php echo app('translator')->get("labels.frontend.home_page.question"); ?></h6><p>'+questionname+'</p></li>');
          if(optionname!='')
          {
            $('#sideOptionName'+step_new).replaceWith('<li><h6><?php echo app('translator')->get("labels.frontend.home_page.option"); ?></h6><p>'+optionname+'</p></li>');
        }
        ...
        var pp=0;
           ...
           //    {
           //        var selectBox = '<label class="cust-radio"><select name="optionsdata['+quest.id+']" onChange="getNextQuestionsByOptionId(this.value)" id="questionTypeSelect"><option><?php echo app('translator')->get("labels.frontend.home_page.select_option"); ?></option></select></label>';
...
if(quesOptDataa)
{
    if(question.question_type=='checkbox' ||question.question_type=='radio')
    {
       $('#optionArea'+step_new).html('');
           ...
           {
            var optionText = '<label class="cust-radio"><textarea name="optionsdata['+question.id+']" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.enter_here"); ?>"></textarea></label>';
            $('#optionArea'+step_new).append(optionText);
        }
    }
}
...
<script type="text/javascript">
  function getQuestionsById(childsubserviceId)
  {
    ...
    //alert('childsubserviceId ->'+childsubserviceId);
          ...
          $.ajax({
            type: "GET",  
            url: '<?php echo URL::to("ajax_get_questions"); ?>',  
...
<script>
    ...
    function getSubserviceIdForChild(subserviceId)
    {
        ...
        $.ajax({
        type: "GET",  
        url: '<?php echo URL::to("ajax_get_childservice"); ?>',  
...
<script type="text/javascript">
    ...
    // alert('categoryId ->'+categoryId);
      ...
      $.ajax({
        type: "GET",  
        url: '<?php echo URL::to("ajax_get_subservice"); ?>',  
  ...
  var next_tab = '#tab'+step_new;    
     ...
     { 
        $('.form-btn').show();
          ...
          $('#multi-step-dataHere').append('<div class="tab-pane usernameTab" id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> <?php echo app('translator')->get("labels.frontend.home_page.identify_yourself"); ?></h2></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png');?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.enter_your_full_name"); ?></h5></div></div></div><div class="form-detail"><div class="form-row"><div class="form-group col-md-12"><input type="text" name="username"  id="username" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div></div><p id="userError"></p></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
      ...
      //******* USERNAME TAB END HERE ******-->
        ...
        { $('.form-btn').show();
            ...
            $('#multi-step-dataHere').append( '<div class="tab-pane mobileNumberTab" id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"> <?php echo app('translator')->get("labels.frontend.home_page.share_your_phone_number"); ?></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png'); ?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.enter_your_cell_phone_number"); ?></h5></div></div></div><div class="form-detail"><div class="input-group form-group mb-3"><div class="input-group-prepend"><span class="input-group-text" id="country-code">+593</span></div><input type="text" name="mobile_number" id="mobile_number" class="form-control" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="mobileError"></p></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" onclick="prevbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn" onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
           ...
           //******* MOBILE NUMBER TAB END HERE ******
            ...
            $('#multi-step-dataHere').append('<div class="tab-pane emailIdTab" id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"><?php echo app('translator')->get("labels.frontend.home_page.we_will_send_you_a_code_to_validate_your_request"); ?></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png'); ?>"><div class="media-body"><h5 class="mt-0"><?php echo app('translator')->get("labels.frontend.home_page.enter_your_email"); ?></h5></div></div></div><div class="form-detail"><div class="input-group form-group mb-3"><input type="email" name="email" id="emailMultiform" class="form-control" placeholder="<?php echo app('translator')->get("labels.frontend.home_page.write_here"); ?>"></div><p class="emailError"></p></div></div><div  class="form-btn mid-btn"><button type="button" class="btn next-btn" id="email_next" onclick="prevbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.previous"); ?></button><button type="button" class="btn pre-btn"  onclick="nextbtnn(this)" ><?php echo app('translator')->get("labels.frontend.home_page.next"); ?></button></div></div></div>');
          ...
          } else 
          {
              ...
              if(check_email == true) 
              {
                ...
                $.ajax({
                    type: "GET",
                    url: '<?php echo URL::to("send_otp_mail"); ?>',
                    data:'email='+email,
                    success: function(data){
                      if(data.success == true) 
                      {
                        ...
                        var append_number_html = "<h5 class='mt-0'><?php echo app('translator')->get('labels.frontend.home_page.enter_the_security_code_sent_to'); ?>" +' ' + email+"</h5>";
          ...
          //End send OTP to mail 
            ...
            $('#multi-step-dataHere').append( '<div class="tab-pane otpVerifyTab" id="step'+step_new+'"><div class="mid-steps"><div class="mid-heading"><h2 class="modal-title"><?php echo app('translator')->get("labels.frontend.home_page.almost_ready"); ?></h2></div><div class="mid-data-fill"><div class="mid-head"><div class="media"><img class="mr-3" src="<?php echo asset('img/frontend/shield.png');?>"><div class="media-body otp_mobile_number"></div></div></div><div class="form-detail"><div class="form-group code-num"><input type="text" name="otpvalue[]" id="otp1" class="form-control inputs"  placeholder="0" maxlength="1"><input type="text" name="otpvalue[]" id="otp2" class="form-control inputs"  placeholder="0" maxlength="1"><input type="text" name="otpvalue[]" id="otp3" class="form-control inputs"  placeholder="0" maxlength="1"><input type="text" name="otpvalue[]" id="otp4" class="form-control inputs"  placeholder="0" maxlength="1"><div>Tiempo restante = <span id="timer"></span></div></div></div></div><div  class="form-btn mid-btn"><button type="button" class="btn pre-btn"  id="sub_mit" onClick="submitMultistepForm()"><?php echo app('translator')->get("labels.frontend.home_page.submit"); ?></button> <button type="submit" class="btn pre-btn" id="submit_form" style="display: none;" ><?php echo app('translator')->get("labels.frontend.home_page.submit"); ?></button></div></div></div>');
...
<?php /**PATH /Applications/MAMP/htdocs/Buskalo_WEB/Buskalo_WEB/resources/views/frontend/includes/footer.blade.php ENDPATH**/ ?>